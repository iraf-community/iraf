...
C --- INITIALIZE FFT 
C
      WRITE(6,*) 'PROGRAM TCOSQ1 AND RELATED MESSAGES:'
...
C
      ...
      END DO
      WRITE(6,*) 'COSQ1 FORWARD-BACKWARD MAX ERROR =',DIFF
C
...
C --- PRINT TEST RESULTS
      ...
      DO I=1,N
         DIFF = MAX(DIFF,ABS(R(I)-RCOPY(I)))
      END DO
      WRITE(6,*) 'COSQ1 BACKWARD-FORWARD MAX ERROR =',DIFF
C
      WRITE(6,'(A,/)') ' END PROGRAM TCOSQ1 AND RELATED MESSAGES'
      STOP
      END

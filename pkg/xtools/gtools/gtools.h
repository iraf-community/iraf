...
define	GT_VXMIN	Memr[$1+GTVXMIN]
define	GT_VXMAX	Memr[$1+GTVXMAX]	
define	GT_VYMIN	Memr[$1+GTVYMIN]
define	GT_VYMAX	Memr[$1+GTVYMAX]
...
define	GT_LCLIP	Memr[$1+GTLCLIP]
define	GT_HCLIP	Memr[$1+GTHCLIP]

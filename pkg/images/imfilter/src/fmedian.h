...
define	FMED_HLOW	Memi[$1+5]  # histogram low side rejection parameter
define	FMED_HHIGH	Memi[$1+6]  # histogram high side rejection parameter
...
define	FMED_ZMIN	Memr[$1+13] # the data minimum
define	FMED_ZMAX	Memr[$1+14] # the data maximum
define	FMED_Z1		Memr[$1+15] # the requested data minimum
define	FMED_Z2		Memr[$1+16] # the requested data maximum
define	FMED_ZLOW	Memr[$1+17] # data low side rejection parameter
define	FMED_ZHIGH	Memr[$1+18] # data high side rejection parameter

...
define	MOD_ZLOW	Memr[$1+7]	# the low pixel cutoff value
define	MOD_ZHIGH	Memr[$1+8]	# the high pixel cutoff value
...
define	MOD_SUM		Memr[$1+11]	# running sum used for computing mean 

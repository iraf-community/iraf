...
define	FMOD_ZMIN	Memr[$1+13] # the data minimum
define	FMOD_ZMAX	Memr[$1+14] # the data maximum
define	FMOD_Z1		Memr[$1+15] # the requested data minimum
define	FMOD_Z2		Memr[$1+16] # the requested data maximum
define	FMOD_ZLOW	Memr[$1+17] # data low side rejection parameter
define	FMOD_ZHIGH	Memr[$1+18] # data high side rejection parameter
define	FMOD_SUM	Memr[$1+19] # running sum for mean calculation

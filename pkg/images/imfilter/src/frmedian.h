...
define	FRMED_ZMIN	Memr[$1+7] # the data minimum
define	FRMED_ZMAX	Memr[$1+8] # the data maximum
define	FRMED_Z1	Memr[$1+9] # the requested data minimum
define	FRMED_Z2	Memr[$1+10] # the requested data maximum
define  FRMED_ZLOW      Memr[$1+11] # data low side rejection parameter
define  FRMED_ZHIGH     Memr[$1+12] # data high side rejection parameter

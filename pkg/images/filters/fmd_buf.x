...
int	col1, col2	# column limits in the image
int	line1, line2	# line limits in the image
pointer	buf		# buffer pointer
int	map		# perform mapping on image lines
real	a1, a2		# limits of input image line
real	b1, b2		# limits of output image line
...
begin
	...
	if (line1 < llast1) {
		...
		if (i >= llast1) {
			...
			call amovi (Memi[bufi], Memi[buf2], ncols)
		    }
		}
	    }

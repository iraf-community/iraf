...
# SELECT_RANGES -- Select array values in the ranges.
# The input and output arrays may be the same.

procedure select_ranges (a, b, ranges)
...
# CHOOSE_RANGESI -- Copy the selected values from array a to b.

int procedure choose_rangesi (indices, a, b, npts, ifirst, ilast)
...
# CHOOSE_RANGESR -- Copy the selected values from array a to b.

int procedure choose_rangesr (indices, a, b, npts, ifirst, ilast)
...
int procedure make_ranges (list, npts, ranges, max_nranges)

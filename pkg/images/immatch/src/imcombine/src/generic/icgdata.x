...
begin
	...
	do i = 1, nimages {
		...
		call amovs (Mems[buf+v2[1]-1], Mems[dbuf[i]+j], npix)
		d[i] = dbuf[i]
	    }
	}
...
begin
	...
	do i = 1, nimages {
		...
		call amovi (Memi[buf+v2[1]-1], Memi[dbuf[i]+j], npix)
		d[i] = dbuf[i]
	    }
	}
...
begin
	...
	do i = 1, nimages {
		...
		call amovr (Memr[buf+v2[1]-1], Memr[dbuf[i]+j], npix)
		d[i] = dbuf[i]
	    }
	}
...
begin
	...
	do i = 1, nimages {
		...
		call amovd (Memd[buf+v2[1]-1], Memd[dbuf[i]+j], npix)
		d[i] = dbuf[i]
	    }
	}

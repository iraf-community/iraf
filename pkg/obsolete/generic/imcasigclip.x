...
procedure imc_asigclipi (log, in, out, sig, nimages)
...
begin
	...
	if (scale) {
		...
		do i = 1, nimages {
	        ...
	        call wtasigclipi (Memi[data], Memr[scales], Memr[zeros],
		    Memr[wts], Memr[outdata], Memr[sigma], nc, nimages,
		    low, high)
		if (sig != NULL) {
		    call amovl (Meml[v2], Meml[v1], IM_MAXDIM)
		...
		do i = 1, nimages {
	        ...
	        call asigclipi (Memi[data], Memr[outdata], Memr[sigma], nc,
		    nimages, low, high)
		if (sig != NULL) {
		    call amovl (Meml[v2], Meml[v1], IM_MAXDIM)
		    j = impnlr (sig, sigdata, Meml[v1])
...
procedure wtasigclipi (data, scales, zeros, wts, output, sigma, npts, nlines,
	lowsigma, highsigma)
...
procedure asigclipi (data, output, sigma, npts, nlines, lowsigma, highsigma)
...
procedure imc_asigclipl (log, in, out, sig, nimages)
...
begin
	...
	if (scale) {
		...
		do i = 1, nimages {
	        ...
	        call wtasigclipl (Memi[data], Memr[scales], Memr[zeros],
		    Memr[wts], Memr[outdata], Memr[sigma], nc, nimages,
		    low, high)
		if (sig != NULL) {
		    call amovl (Meml[v2], Meml[v1], IM_MAXDIM)
		...
		do i = 1, nimages {
	        ...
	        call asigclipl (Memi[data], Memr[outdata], Memr[sigma], nc,
		    nimages, low, high)
		if (sig != NULL) {
		    call amovl (Meml[v2], Meml[v1], IM_MAXDIM)
		    j = impnlr (sig, sigdata, Meml[v1])
...
procedure wtasigclipl (data, scales, zeros, wts, output, sigma, npts, nlines,
	lowsigma, highsigma)
...
procedure asigclipl (data, output, sigma, npts, nlines, lowsigma, highsigma)
...
procedure imc_asigclipd (log, in, out, sig, nimages)
...
begin
	...
	if (scale) {
		...
		do i = 1, nimages {
	        ...
	        call wtasigclipd (Memi[data], Memr[scales], Memr[zeros],
		...
		do i = 1, nimages {
	        ...
	        call asigclipd (Memi[data], Memd[outdata], Memd[sigma], nc,
		    nimages, low, high)
		if (sig != NULL) {
		    call amovl (Meml[v2], Meml[v1], IM_MAXDIM)
		    j = impnld (sig, sigdata, Meml[v1])
...
procedure wtasigclipd (data, scales, zeros, wts, output, sigma, npts, nlines,
	lowsigma, highsigma)
...
begin
	...
	do i = 1, npts {
	    ...
	    Memd[mean+i-1] = sum / (1 - minwt - maxwt)
	    sum = sum + minwt * low + maxwt * high
	    output[i] = sum
	}
...
procedure asigclipd (data, output, sigma, npts, nlines, lowsigma, highsigma)

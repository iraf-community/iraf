...
define	RS_LOWER	Memr[$1]		# lower good data limit
define	RS_UPPER	Memr[$1+1]		# upper good data limit
define	RS_LNSIGREJ	Memr[$1+2]              # low side clipping factor
define	RS_UNSIGREJ	Memr[$1+3]              # high side clipping factor
define	RS_BINWIDTH	Memr[$1+4]              # histogram binwidth
define	RS_BLANK	Memr[$1+5]		# undefined pixel value

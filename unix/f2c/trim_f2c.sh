...
################### F2C ######################
# Base: "src" subdir of f2c-20100827.tar.gz, f.e. from the Debian sources
# Remove files not needed here
rm -f src/f2c.h src/readme src/tokdefs.h src/xsum0.out src/index.html src/mkfile.plan9 

################# LIBF2C ####################
# Base: "src" subdir of libf2c2-20090411.tar.gz, f.e. from the Debian sources
# Remove files not needed here
rm -f libf2c/xsum0.out

...
extern integer zardpr_(integer *chan, shortint *buf, integer *maxbytes, integer *loffset);
...
extern integer zgettx_(integer *fd, shortint *buf, integer *maxchars, integer *status);
extern integer zgetty_(integer *fd, shortint *buf, integer *maxchars, integer *status);

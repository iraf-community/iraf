...
c
      data small(1),small(2)	/524288,	0/
      data large(1),large(2)	/2145386495,   -1/
      data right(1),right(2)	/970,		0/
      data diver(1),diver(2)	/971,		0/
      data log10(1),log10(2)	/1072049730,	-17155601/
c

     ...
     *(5)/103/,dlong(6)/101/,dlong(7)/114/,dlong(8)/42/,dlong(9)/56/,dlo
     *ng(10)/-2/
      data dpntr(1)/105/,dpntr(2)/110/,dpntr(3)/116/,dpntr(4)/101/,dpntr
     *(5)/103/,dpntr(6)/101/,dpntr(7)/114/,dpntr(8)/42/,dpntr(9)/56/,dpn
     *tr(10)/-2/
      data dsizet(1)/105/,dsizet(2)/110/,dsizet(3)/116/,dsizet(4)/101/,d
     *sizet(5)/103/,dsizet(6)/101/,dsizet(7)/114/,dsizet(8)/42/,dsizet(9
     *)/56/,dsizet(10)/-2/
#else	/* ILP64 */
      data dbool(1)/108/,dbool(2)/111/,dbool(3)/103/,dbool(4)/105/,dbool
     *(5)/99/,dbool(6)/97/,dbool(7)/108/,dbool(8)/-2/
     ...
     *(5)/103/,dpntr(6)/101/,dpntr(7)/114/,dpntr(8)/-2/
      data dsizet(1)/105/,dsizet(2)/110/,dsizet(3)/116/,dsizet(4)/101/,d
     *sizet(5)/103/,dsizet(6)/101/,dsizet(7)/114/,dsizet(8)/-2/
#endif
#else	/* ILP32 */
      data dbool(1)/108/,dbool(2)/111/,dbool(3)/103/,dbool(4)/105/,dbool
     *(5)/99/,dbool(6)/97/,dbool(7)/108/,dbool(8)/-2/

...
# endif
	...
	/* parser tables file name */

# ifndef TABFILE
# define TABFILE "yacc.tab"
# endif

	/* user global declarations file name */
...
/* y1.c */
extern void error( const char *argsformat, ... );
extern void closure( int );
extern void aryfil( int *, int, int );
extern void putitem( int *, struct looksets * );
extern int state( int );
extern char *symnam( int );
extern const char *writem( int * );
/* y2.c */
...
extern void warray ( const char *, int *, int );

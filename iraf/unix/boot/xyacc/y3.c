...
static int exca[NSTATES*2];	/* buffer states for printing with warray  */
static int nexca;

static void precftn( int, int, int );
static void wract( int );
static void wdef( const char *, int );
...
static void wdef( const char *s, int n )

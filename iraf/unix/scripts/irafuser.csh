...
case macosx:
    ...
    setenv HSI_CF "-I$hinclude -O -DMACOSX -Wall -arch ppc"
...
case macintel:
    ...
    setenv HSI_CF "-I$hinclude -O -DMACOSX -DMACINTEL -Wall -arch i386"
...
case linux:
    setenv HSI_CF "-I$hinclude -O -DLINUX -DPOSIX -DSYSV -Wall"
...
case redhat:
    setenv HSI_CF "-I$hinclude -O -DLINUX -DREDHAT -DPOSIX -DSYSV -Wall"
    setenv HSI_XF "-Inolibc -w -/Wunused"
    setenv HSI_FF "-O"
...
case sunos:
    setenv HSI_CF "-I$hinclude -O -DSOLARIS -DX86 -DPOSIX -DSYSV -Wall"
    setenv HSI_XF "-Inolibc -w -/Wunused"
    setenv HSI_FF "-O"
...
case linuxppc:
    setenv HSI_CF "-I$hinclude -O -DLINUX -DREDHAT -DLINUXPPC -DPOSIX -DSYSV -Wall"
    setenv HSI_XF "-Inolibc -w -/Wunused"
    setenv HSI_FF "-O"
    setenv HSI_LF ""
    setenv HSI_F77LIBS ""
...
case cygwin:
    setenv HSI_CF "-I$hinclude -O -DCYGWIN -DLINUX -DREDHAT -DPOSIX -DSYSV -Wall"

...
define	GS_TYPE		Memi[P2I($1+16)]	# Type of curve to be fitted
define	GS_XORDER	Memi[P2I($1+17)]	# Order of the fit in x
define	GS_YORDER	Memi[P2I($1+18)]	# Order of the fit in y
define	GS_XTERMS	Memi[P2I($1+19)]	# Cross terms for polynomials

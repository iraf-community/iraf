...
double	k1, k2		# normalizing constants
double	basis[ARB]	# basis functions
size_t	left[ARB]	# indices of the appropriate spline functions
...
begin
	...
	call achtdp (basis[1+npts], left, npts)
	np = npieces
	call aminkp (left, np, left, npts)
...
double	k1, k2		# normalizing constants
double	basis[ARB]	# array of basis functions
size_t	left[ARB]	# array of indices for first non-zero spline

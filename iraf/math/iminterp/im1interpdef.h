...
define	ASI_TYPE	Memi[P2I($1)]	# interpolator type
define	ASI_NSINC	Memi[P2I($1+1)]	# sinc interpolator half-width
define	ASI_NINCR	Memi[P2I($1+2)]	# number of sinc interpolator luts
...
define	LTABLE		Memr[$1]	# element of the look-up table

...
begin
	...
	case II_BISINC:
	    ...
	    call ii_bisinc (COEFF(MSI_COEFF(msi)), MSI_FSTPNT(msi),
			    sz_val0, sz_val1, x, y, value, c_1,
			    MSI_NSINC(msi), DX, DY)
	    return (value)

	case II_BILSINC:
	    call ii_bilsinc (COEFF(MSI_COEFF(msi)), MSI_FSTPNT(msi),
	        MSI_NXCOEFF(msi), MSI_NYCOEFF(msi), x, y, value, c_1,

...
define	MSI_TYPE	Memi[P2I($1)]	# interpolant type
define	MSI_NSINC	Memi[P2I($1+1)]	# interpolant type
define	MSI_NXINCR	Memi[P2I($1+2)]	# interpolant type
define	MSI_NYINCR	Memi[P2I($1+3)]	# interpolant type
...
define	LTABLE		Memr[$1]	# element of look-up array

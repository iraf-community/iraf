...
define	T_LEN		Memi[P2I($1)]	# length of tty structure
define	T_OP		Memi[P2I($1+1)]	# offset into caplist
define	T_PADCHAR	Memi[P2I($1+2)]	# pad character for delays
define	T_TABCHAR	Memi[P2I($1+3)]	# tab character, if HW tabs ok
define	T_BSOK		Memi[P2I($1+4)]	# terminal backspaces with BS
define	T_HTOK		Memi[P2I($1+5)]	# term has HT (horiz tab) in hardware
define	T_AM		Memi[P2I($1+6)]	# term has automargin advance
define	T_SOTYPE	Memi[P2I($1+7)]	# type of standout mode (ttyputline)
define	T_BAUD		Memi[P2I($1+8)]	# baud rate for delays
define	T_NLINES	Memi[P2I($1+9)]	# nlines on terminal at open
define	T_NCOLS		Memi[P2I($1+10)]	# ncols on terminal at open
define	T_NCAPS		Memi[P2I($1+11)]	# number of capabilities
define	T_CAPLEN	Memi[P2I($1+12)]	# length of caplist, chars
			# (extra space)
define	T_CAPCODE	Memi[P2I($1+15)]	# cap code array: c1*128+c2
define	T_CAPINDEX	Memi[P2I($1+115)+$2-1]	# cap index array

...
int c_poll ( int fds, int nfds, int timeout )
{
	XINT	npoll;
	XPOINTER x_fds = fds;
	XINT x_nfds = nfds;
...
/* fd   : no. descriptors    */
/* type : event type         */
void c_poll_set ( int fds, int fd, int type )
{
	XPOINTER x_fds = fds;
	XINT x_fd = fd;
	XINT x_type = type;
...
/* fd   : no. descriptors    */
/* type : event type         */
void c_poll_clear ( int fds, int fd, int type )
{
	XPOINTER x_fds = fds;
	XINT x_fd = fd;
	XINT x_type = type;
...
/* fd   : no. descriptors    */
/* type : event type         */
int c_poll_test ( int fds, int fd, int type )
{
	XPOINTER x_fds = fds;
	XINT x_fd = fd;
	XINT x_type = type;

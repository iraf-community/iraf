...
define	LEN_FSLOT	4
define	FC_NREF		Memi[P2I($1)]		# number of refs to this slot
define	FC_LRU		Memi[P2I($1+1)]		# LRU count for slot
define	FC_LFILE	Memi[P2I($1+2)]		# lfile assigned to slot
define	FC_FD		Memi[P2I($1+3)]		# file descriptor

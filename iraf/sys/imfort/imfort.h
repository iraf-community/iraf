...
define	IM_LINEBUFP	Memi[P2I($1+5)]	# line buffer pointer
define	IM_SZPIXEL	Memi[P2I($1+6)]	# pixel size, chars
define	IM_SWAP		Memi[P2I($1+7)]	# swap pixels
define	IM_LENHDRMEM	Memi[P2I($1+8)]	# buffer length of std hdr + user area
define	IM_UABLOCKED	Memi[P2I($1+9)]	# is user area blocked to 80 cols/card

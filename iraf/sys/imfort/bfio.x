...
define	LEN_BFIO	10
define	BF_CHAN		Memi[P2I($1)]		# OS channel
define	BF_ACMODE	Memi[P2I($1+1)]		# access mode
define	BF_BUFP		Memi[P2I($1+2)]		# buffer pointer
define	BF_BUFSIZE	Memi[P2I($1+3)]		# buffer capacity, chars
define	BF_BUFCHARS	Memi[P2I($1+4)]		# amount of data in buffer
define	BF_BUFOFFSET	Memi[P2I($1+5)]		# file offset of buffer
define	BF_FILEOFFSET	Memi[P2I($1+6)]		# file offset for seq i/o
define	BF_UPDATE	Memi[P2I($1+7)]		# write buffer to disk
define	BF_BLKSIZE	Memi[P2I($1+8)]		# device block size

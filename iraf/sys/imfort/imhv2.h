...
define  IM_V2HGMOFF	Meml[P2L($1+24)]		# offset of hgm pixels
define  IM_V2BLIST	Meml[P2L($1+25)]		# offset of bad pixel list
define  IM_V2SZBLIST	Meml[P2L($1+26)]		# size of bad pixel list
define  IM_V2NBPIX	Meml[P2L($1+27)]		# number of bad pixels
define	IM_V2CTIME	Meml[P2L($1+28)]		# time of image creation
define	IM_V2MTIME	Meml[P2L($1+29)]		# time of last modify
define	IM_V2LIMTIME	Meml[P2L($1+30)]		# time min,max computed

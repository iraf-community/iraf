...
define	IMD_FILLAREA	Memi[P2I($1+6)]		# device supports fillarea
define	IMD_CELLARRAY	Memi[P2I($1+7)]		# device supports cell array
define	IMD_XRES	Memi[P2I($1+8)]		# device resolution in X
define	IMD_YRES	Memi[P2I($1+9)]		# device resolution in Y
define	IMD_ZRES	Memi[P2I($1+10)]		# device resolution in Z
define	IMD_FILLSTYLE	Memi[P2I($1+11)]		# number of fill styles
define	IMD_ROAM	Memi[P2I($1+12)]		# device supports roam
define	IMD_ZOOM	Memi[P2I($1+13)]		# device supports zoom
define	IMD_SELERASE	Memi[P2I($1+14)]		# device has selective erase
define	IMD_PIXREP	Memi[P2I($1+15)]		# device supports pixel replic.
define	IMD_STARTFRAME	Memi[P2I($1+16)]		# frame advance at metafile BOF
define	IMD_ENDFRAME	Memi[P2I($1+17)]		# frame advance at metafile EOF
	# extra space
define	IMD_CURSOR	Memi[P2I($1+20)]		# last cursor accessed
define	IMD_COLOR	Memi[P2I($1+21)]		# last color set
define	IMD_TXSIZE	Memi[P2I($1+22)]		# last text size set

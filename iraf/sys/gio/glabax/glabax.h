...
define	AX_DRAWME		Memi[P2I($1+4)]		# draw this axis
define	AX_HORIZONTAL		Memi[P2I($1+5)]		# axis is horizontal
define	AX_SCALING		Memi[P2I($1+6)]		# type of scaling
define	AX_DRAWTICKS		Memi[P2I($1+7)]		# draw the ticks
...
define	AX_NMINOR		Memi[P2I($1+20)]	# nminor ticks
define	AX_NLEFT		Memi[P2I($1+21)]	# nminor to next major
define	AX_INLEFT		Memi[P2I($1+22)]	# initial nleft
define	AX_NDIGITS		Memi[P2I($1+23)]	# ndigits of precision
...
define	AX_LABELTICKS		Memi[P2I($1+30)]	# draw tick labels
...
define	AX_TICKLABELCOLOR	Memi[P2I($1+34)]	# char size of ticklabel
define	AX_TICKCOLOR		Memi[P2I($1+35)]	# grid between ticks
define	AX_AXISLABELSIZE	Memr[P2R($1+36)]	# char size axislabel
define	AX_AXISLABELCOLOR	Memi[P2I($1+37)]	# char size axislabel
define	AX_AXISWIDTH		Memr[P2R($1+38)]	# axis linewidth
define	AX_AXISCOLOR		Memi[P2I($1+39)]	# axis linewidth
define	AX_GRIDCOLOR		Memi[P2I($1+40)]	# grid between ticks

...
define	CCP_SBUF	Memi[P2I($1)]		# string buffer
define	CCP_SZSBUF	Memi[P2I($1+1)]		# size of string buffer
define	CCP_NEXTCH	Memi[P2I($1+2)]		# next char pos in string buf
define	CCP_NCHARSIZES	Memi[P2I($1+3)]		# number of character sizes
define	CCP_POLYLINE	Memi[P2I($1+4)]		# device supports polyline
define	CCP_POLYMARKER	Memi[P2I($1+5)]		# device supports polymarker
define	CCP_FILLAREA	Memi[P2I($1+6)]		# device supports fillarea
define	CCP_CELLARRAY	Memi[P2I($1+7)]		# device supports cell array
define	CCP_ZRES	Memi[P2I($1+8)]		# device resolution in Z
define	CCP_FILLSTYLE	Memi[P2I($1+9)]		# number of fill styles
define	CCP_ROAM	Memi[P2I($1+10)]		# device supports roam
define	CCP_ZOOM	Memi[P2I($1+11)]		# device supports zoom
define	CCP_SELERASE	Memi[P2I($1+12)]		# device has selective erase
define	CCP_PIXREP	Memi[P2I($1+13)]		# device supports pixel replic.
define	CCP_STARTFRAME	Memi[P2I($1+14)]		# frame advance at metafile BOF
define	CCP_ENDFRAME	Memi[P2I($1+15)]		# frame advance at metafile EOF
	# extra space
define	CCP_CURSOR	Memi[P2I($1+20)]		# last cursor accessed
define	CCP_COLOR	Memi[P2I($1+21)]		# last color set
define	CCP_TXSIZE	Memi[P2I($1+22)]		# last text size set
define	CCP_TXFONT	Memi[P2I($1+23)]		# last text font set
define	CCP_LTYPE	Memi[P2I($1+24)]		# last line type set
define	CCP_WIDTH	Memi[P2I($1+25)]		# last line width set
define	CCP_DEVNAME	Memi[P2I($1+26)]		# name of open device
define	CCP_DEVCHAN	Memi[P2I($1+27)]		# channel for "plots(0,0,ldev)"
	# extra space
define	CCP_CHARHEIGHT	Memi[P2I($1+30+$2-1)]	# character height
define	CCP_CHARWIDTH 	Memi[P2I($1+40+$2-1)]	# character width

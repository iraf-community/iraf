...
define	V_LENEXTN	Memi[P2I($1+4)]		# length of EXTN string
define	V_LONGROOT	Memi[P2I($1+5)]		# root field exceeds OS limit
...
define	M_ADDZMD	Memi[P2I($1+6)]		# create .zmd file at update
define	M_DELZMD	Memi[P2I($1+7)]		# delete .zmd file at update

...
define	PS_EXPBLEN	Memi[P2I($1)]	# QPEX program buffer length
define	PS_EXDBLEN	Memi[P2I($1+1)]	# QPEX data buffer length
define	PS_EXMAXFRLLEN	Memi[P2I($1+2)]	# QPEX max FRLUT length
define	PS_EXMAXRRLLEN	Memi[P2I($1+3)]	# QPEX max RRLUT length
define	PS_EXLMINRANGES	Memi[P2I($1+4)]	# QPEX max ranges before using LUT
define	PS_EXLSCALE	Memi[P2I($1+5)]	# QPEX scale nranges to LUT bins
...
define	PS_STSBUFSIZE	Memi[P2I($1+14)]	# SYMTAB sbuf size (start)
define	PS_NODEFFILT	Memi[P2I($1+15)]	# Disable use of default filter
define	PS_NODEFMASK	Memi[P2I($1+16)]	# Disable use of default mask

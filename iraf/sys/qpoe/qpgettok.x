...
define	GT_LEVEL	Memi[P2I($1+4)]	# current nesting level
define	GT_SVFD		Memi[P2I($1+5)+$2-1]	# stacked file descriptors
define	GT_SVFTEMP	Memi[P2I($1+25)+$2-1]# stacked ftemp flags

...
define	LEN_SVDES	3
define	SV_MAGIC	Memi[P2I($1)]	# identifies file type
define	SV_TITLELEN	Memi[P2I($1+1)]	# title string length, including EOS
define	SV_MASKLEN	Memi[P2I($1+2)]	# encoded mask length, shorts

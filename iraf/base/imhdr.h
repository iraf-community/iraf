...
define	IM_HGMOFF	Meml[P2L($1+IMD+25)]		# offset of hgm pixels
define	IM_BLIST	Meml[P2L($1+IMD+26)]		# offset of bad pixel list
define	IM_SZBLIST	Meml[P2L($1+IMD+27)]		# size of bad pixel list
define	IM_NBPIX	Meml[P2L($1+IMD+28)]		# number of bad pixels
define	IM_CTIME	Meml[P2L($1+IMD+29)]		# time of image creation
define	IM_MTIME	Meml[P2L($1+IMD+30)]		# time of last modify
define	IM_LIMTIME	Meml[P2L($1+IMD+31)]		# time min,max computed
...
define	HGM_TIME	Meml[P2L($1)]		# time when hgm was computed
define	HGM_LEN		Meml[P2L($1+1)]		# number of bins in hgm
define	HGM_NPIX	Meml[P2L($1+2)]		# npix used to compute hgm

...
define	IM_FILESIZE	Meml[P2L($1)]		# size of pixfile
define	IM_NGET		Meml[P2L($1+1)]		# number getpix calls
define	IM_ACMODE	Memi[P2I($1+2)]		# access mode (ro, rw, etc.)
...
define	IM_SWAP		Memi[P2I($1+23)]		# byte swapping required

...
int	xnelem			# number of elements for indep var column
...
begin
	...
	# Define indep var column in output table.
	if (array)
	    nelem = outrows
	else
	    nelem = 1
	call tbcdef1 (otp, iv_ocp, cname, cunits, cfmt, dtype, nelem)
	...
	# Define the other columns in the output table.
	ncols = 0
	do k = 1, incols {

...
define	NUM_KEYWORDS	Memi[P2I($1)]	# total number of keywords
define	NUM_MATCH	Memi[P2I($1+1)]	# number of keywords that match template
define	KW_NAME_PTR	Memi[P2I($1+2)]	# list of keyword names
define	KW_TYPE_PTR	Memi[P2I($1+3)]	# list of keyword data types
define	KW_MATCH_PTR	Memi[P2I($1+4)]	# indexes of keywords matching template

...
define	LEN_DIM_INFO	T_MAXDIM + 1	# unit = SZ_INT
define	TCR_NDIM 	Memi[Memi[P2I($1)+$2-1]]	# dimension of array
define	TCR_AXLEN 	Memi[Memi[P2I($1)+$2-1]+$3]	# length of an axis

...
define	TB_TYPE			Memi[P2I($1)]	# what type of table
define	TB_NPAR			Memi[P2I($1+1)]	# number of user paramters
define	TB_MAXPAR		Memi[P2I($1+2)]	# max number of user paramters
define	TB_NROWS		Memi[P2I($1+3)]	# number of rows
define	TB_ALLROWS		Memi[P2I($1+4)]	# (C) allocated number of rows
define	TB_NCOLS		Memi[P2I($1+5)]	# number of columns
define	TB_MAXCOLS		Memi[P2I($1+6)]	# current max number of columns
define	TB_COLUSED		Memi[P2I($1+7)]	# (R) chars used by columns
define	TB_ROWLEN		Memi[P2I($1+8)]	# (R) row length = chars alloc
define	TB_VERSION		Memi[P2I($1+9)]	# Software version number
define	TB_BOD			Meml[P2L($1+10)]	# L beg of data (in SZ_CHAR)
define	TB_IOMODE		Memi[P2I($1+11)]	# I/O mode

# Flags
define	TB_IS_OPEN		Memb[P2B($1+12)]	# Table is open?
define	TB_READONLY		Memb[P2B($1+13)]	# Readonly?
define	TB_MODIFIED		Memb[P2B($1+14)]	# Actually been changed?

# File descriptor for the table file
define	TB_FILE			Memi[P2I($1+15)]

# Pointers.  TB_INDEF is only used for row-ordered tables.
define	TB_INDEF		Memi[P2I($1+16)]	# Pointer to indef record buffer
define	TB_COLPTR		Memi[P2I($1+17)]	# Ptr to array of column ptrs

# These are for tables in CDF files or FITS files.
define	TB_F_TYPE		Memi[P2I($1+18)]	# CDF, FITS, or ordinary file
define	TB_HDU			Memi[P2I($1+19)]	# number of HDU in FITS file
define	TB_EXTVER		Memi[P2I($1+20)]	# version number
define	TB_OVERWRITE		Memi[P2I($1+21)]	# +1 --> yes, 0 --> no
define	TB_HDUTYPE		Memi[P2I($1+22)]	# 1--> ascii; 2 --> binary
define	TB_CD			Memi[P2I($1+23)]	# returned by cd_open()
define	TB_EXTNAME_PTR		Memi[P2I($1+24)]	# pointer to CDF name or EXTNAME
define	TB_EXTNAME		Memc[TB_EXTNAME_PTR($1)]

# These two are for text tables.
define	TB_COMMENT		Memi[P2I($1+25)]	# pointer to comment string
define	TB_SZ_COMMENT		Memi[P2I($1+26)]	# size of comment string

# Table name
define	TB_NAME_PTR		Memi[P2I($1+27)]	# pointer to table name string
...
define	COL_LEN			Memi[P2I($1+2)]	# Chars for data element

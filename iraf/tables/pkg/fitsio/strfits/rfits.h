...
define  FITS_NROWS      Memi[P2I($1+12)]      # Number of lines in table
define  FITS_ROWLEN     Memi[P2I($1+13)]      # Number of character per row
define  NAXIS           Memi[P2I($1+14)]      # Number of dimensions 
define  NAXISN          Memi[P2I($1+15)+$2-1] # Length of each axis (up to 7)
...
define  EXT_PBCOL       Memi[P2I($1+4)]  # Pointer the array of columns
...
define  EXT_PUNIT       Memi[P2I($1+9)]  # Pointer to array of TUNITs values.
define  EXT_PTYPE       Memi[P2I($1+10)] # Pointer to array of TTYPEs values.
define  EXT_PDTYPE      Memi[P2I($1+11)] # Pointer to array of Tdatatype values.
define  EXT_PDSIZE      Memi[P2I($1+12)] # Pointer to array of Tdatatype sizes
                                         # or number of elements for a BINTABlE
                                         # column.
define  EXT_PFORM       Memi[P2I($1+13)] # Pointer to array of TFORMs values.
define  EXT_PDISP       Memi[P2I($1+14)] # Pointer to array of TDISP values.

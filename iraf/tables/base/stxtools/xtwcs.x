...
define	W_VALID		Memi[P2I($1)]	# coordinates valid, YES or NO?
define	W_NAXIS		Memi[P2I($1+1)]	# number of axes
define	W_RA_AX		Memi[P2I($1+2)]	# which axis is RA?  zero if none
define	W_DEC_AX	Memi[P2I($1+3)]	# which axis is Dec?  zero if none
define	W_PROJECTION	Memi[P2I($1+4)]	# projection type

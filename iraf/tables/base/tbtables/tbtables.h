...
define	TB_TYPE			Memi[P2I($1+4)]	# what type of table
...
# Flags
define	TB_IS_OPEN		Memb[P2B($1+17)]	# Table is open?
define	TB_READONLY		Memb[P2B($1+18)]	# I/O mode is read-only?
define	TB_MODIFIED		Memb[P2B($1+19)]	# Has table been changed?

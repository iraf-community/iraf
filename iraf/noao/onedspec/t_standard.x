...
define	STD_AP		Memi[P2I($1)]	# Aperture number
define	STD_TYPE	Memi[P2I($1+1)]	# Spectrum type	
define	STD_SH		Memi[P2I($1+2)]	# Pointer to spectrum parameters
define	STD_IFLAG	Memi[P2I($1+3)]	# Interactive flag
define	STD_NWAVES	Memi[P2I($1+4)]	# Number of calibration points
define	STD_WAVES	Memi[P2I($1+5)]	# Pointer to standard star wavelengths
define	STD_DWAVES	Memi[P2I($1+6)]	# Pointer to standard star bandpasses
define	STD_MAGS	Memi[P2I($1+7)]	# Pointer to standard star magnitudes
define	STD_FLUXES	Memi[P2I($1+8)]	# Pointer to standard star fluxes
define	CAL_NWAVES	Memi[P2I($1+9)]	# Number of calibration points
define	CAL_WAVES	Memi[P2I($1+10)]	# Pointer to calibration wavelengths
define	CAL_DWAVES	Memi[P2I($1+11)]	# Pointer to calibration bandpasses
define	CAL_MAGS	Memi[P2I($1+12)]	# Pointer to calibration magnitudes

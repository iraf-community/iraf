...
define	REF_AP		Memi[P2I($1+2)]	# Aperture number
define	REF_GVAL	Memi[P2I($1+3)]	# Sort value
define	REF_SPEC1	Memi[P2I($1+4)]	# Offset for reference spectrum 1
define	REF_SPEC2	Memi[P2I($1+5)]	# Offset for reference spectrum 2

...
define	DC_FORMAT	Memi[P2I($1)]	# Type of dispersion
define	DC_PAPS		Memi[P2I($1+1)]	# Pointer to aperture numbers
define	DC_PAPCEN	Memi[P2I($1+2)]	# Pointer to aperture centers
define	DC_PUN		Memi[P2I($1+3)]	# Pointer to units
define	DC_PSHIFT	Memi[P2I($1+4)]	# Pointer to shifts
define	DC_PCOEFF	Memi[P2I($1+5)]	# Pointer to coefficients
define	DC_NAPS		Memi[P2I($1+6)]	# Number of apertures
define  DC_OFFSET       Memi[P2I($1+7)]      # Aperture to order offset
define  DC_SLOPE        Memi[P2I($1+8)]      # Aperture to order slope
define  DC_COEFFS       Memi[P2I($1+9)]      # Dispersion coefficients

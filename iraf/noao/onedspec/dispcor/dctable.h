...
define	TBL_AP		Memi[P2I($1+10)]	# Aperture
define	TBL_NW		Memi[P2I($1+11)]	# Number of points
define	TBL_NWMAX	Memi[P2I($1+12)]	# Maximum number of points for global
define	TBL_CONFIRM	Memi[P2I($1+13)]	# Confirm?

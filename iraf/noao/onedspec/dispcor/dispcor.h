...
define	DC_PL	Memi[P2I($1+($2-1)*20+1)]		# Physical line number
define	DC_AP	Memi[P2I($1+($2-1)*20+2)]		# Aperture number
define	DC_BM	Memi[P2I($1+($2-1)*20+3)]		# Beam number
define	DC_DT	Memi[P2I($1+($2-1)*20+4)]		# Dispersion type
define	DC_NW	Memi[P2I($1+($2-1)*20+5)]		# Number of pixels in spectrum
...
define	DC_CF	Memi[P2I($1+($2-1)*20+18)]		# Pointer to coefficients
define	DC_UN	Memi[P2I($1+($2-1)*20+19)]		# Units

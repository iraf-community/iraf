...
define	SP_INDEX	Memi[P2I($1)]		# Index
define	SP_SH		Memi[P2I($1+1)]		# Spectrum header
define	SP_NPTS		Memi[P2I($1+2)]		# Number of data points
...
define	SP_PX		Memi[P2I($1+15)]		# Pointer to wavelengths
define	SP_PY		Memi[P2I($1+16)]		# Pointer to intensities
define	SP_XLPOS	Memr[P2R($1+17)]	# X label position
define	SP_YLPOS	Memr[P2R($1+18)]	# Y label position
define	SP_COLOR	Memi[P2I($1+19)]		# Color

...
define	AID_CDDIR	Memi[P2I($1+450)]	# Coordinate direction
define	AID_NTMAX	Memi[P2I($1+451)]	# Maximum number of target lines
define	AID_NRMAX	Memi[P2I($1+452)]	# Maximum number of reference lines
define	AID_ORD		Memi[P2I($1+453)]	# Maximum fitting order
define	AID_MAXNL	Memr[P2R($1+454)]	# Maximum non-linearity
define	AID_NB		Memi[P2I($1+455)]	# Number of sub-bins
define	AID_NN		Memi[P2I($1+456)]	# Number of neighbor lines
define	AID_NP		Memi[P2I($1+457)]	# Number of lines in pattern
define	AID_SIG		Memr[P2R($1+458)]	# Target line centering sigma
define	AID_NFOUND	Memi[P2I($1+459)]	# Minimum number to be found
...
define	AID_IDT		Memi[P2I($1+463)]	# Target ID pointer
define	AID_IDR		Memi[P2I($1+464)]	# Reference ID pointer
define	AID_IC1		Memi[P2I($1+465)]	# ICFIT pointer
define	AID_IC2		Memi[P2I($1+466)]	# ICFIT pointer

define	AID_XR		Memi[P2I($1+467)]	# Reference lines (ptr)
define	AID_NR		Memi[P2I($1+468)]	# Number of reference lines
define	AID_XTF		Memi[P2I($1+469)]	# Full target lines sorted by peak
define	AID_NTF		Memi[P2I($1+470)]	# Full number of target lines
define	AID_XT		Memi[P2I($1+471)]	# Target lines to use sorted by pix
define	AID_XTL		Memi[P2I($1+472)]	# Linearized target lines sorted by pix
define	AID_NT		Memi[P2I($1+473)]	# Number of target lines to use

define	AID_CDSIGN	Memi[P2I($1+474)]		# Sign of coordinate interval
...
define	AID_NDMAX	Memi[P2I($1+497)]	# Max number of dispersions to check
...
define	AID_NBEST	Memi[P2I($1+504)]	# Number of best values < 1 to check
define	AID_BEST	Memr[P2R($1+505)]	# Best fit parameter
define	AID_EVS		Memi[P2I($1+506)]	# Evaluate structure

define	AID_SPECR	Memi[P2I($1+507)]	# Reference spectrum (ptr)
define	AID_X1R		Memi[P2I($1+508)]	# First pixel of full ref spectrum
define	AID_X2R		Memi[P2I($1+509)]	# Last pixel of full ref spectrum
...
define	AID_EVLEN	8
define	AID_BIN1	Memi[P2I($1)]	# Reference sample bin
define	AID_BIN2	Memi[P2I($1+1)]	# Reference sample bin
define	AID_X		Memi[P2I($1+2)]	# Pixel coordinates
define	AID_Y		Memi[P2I($1+3)]	# Dispersion coordinates
define	AID_N		Memi[P2I($1+4)]	# Number of coordinate pairs
define	AID_A		Memi[P2I($1+5)]	# Trial dispersion start
define	AID_B		Memi[P2I($1+6)]	# Trial dispersion step
define	AID_ND		Memi[P2I($1+7)]	# Number of trial dispersions

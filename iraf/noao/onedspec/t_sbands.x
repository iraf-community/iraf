...
define	BAND_ID		Memi[P2I($1)]		# ptr to band id string
define	BAND_FILTER	Memi[P2I($1+1)]		# ptr to filter string
define	BAND_WC		Memd[P2D($1+2)]		# center wavelength
define	BAND_DW		Memd[P2D($1+4)]		# wavelength width
define	BAND_FN		Memi[P2I($1+6)]		# no. of filter points
define	BAND_FW		Memi[P2I($1+7)]		# ptr to filter wavelengths
define	BAND_FR		Memi[P2I($1+8)]		# ptr to filter responses
...
define	BAND2		2
define	BAND3		3
define	BAND		Memi[P2I($1)+($2-1)*NBANDS+($3-1)]

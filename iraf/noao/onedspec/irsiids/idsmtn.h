...
define	LINE			Memi[P2I($1+6)]
define	NP1			Memi[P2I($1+7)]
define	NP2			Memi[P2I($1+8)]
define	ITM			Memr[P2R($1+9)]
define	BEAM			Memi[P2I($1+10)]
define	W			Memi[P2I($1+11)]
define	UT			Memr[P2R($1+13)]
define	ST			Memr[P2R($1+14)]
define	DF_FLAG			Memi[P2I($1+15)]
define	SM_FLAG			Memi[P2I($1+16)]
define	QF_FLAG			Memi[P2I($1+17)]
define	DC_FLAG			Memi[P2I($1+18)]
define	QD_FLAG			Memi[P2I($1+19)]
define	EX_FLAG			Memi[P2I($1+20)]
define	BS_FLAG			Memi[P2I($1+21)]
define	CA_FLAG			Memi[P2I($1+22)]
define	CO_FLAG			Memi[P2I($1+23)]
define	OFLAG			Memi[P2I($1+24)]
define	POINT			Memi[P2I($1+25)]	
define	DRA			Memi[P2I($1+26)]
define	DDEC			Memi[P2I($1+27)]

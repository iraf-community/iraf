...
define	EC_IMAGE	Memi[P2I($1)]	# Image name (pointer)
...
define	EC_DATABASE	Memi[P2I($1+9)]	# Name of database (pointer)
define	EC_COORDLIST	Memi[P2I($1+10)]	# Name of coordinate list (pointer)
define	EC_LABELS	Memi[P2I($1+11)]	# Type of feature labels
define	EC_LOGFILES	Memi[P2I($1+12)]	# List of logfiles

# Common image data

define	EC_NCOLS	Memi[P2I($1+13)]	# Number of columns
define	EC_NLINES	Memi[P2I($1+14)]	# Number of lines/apertures/orders
define	EC_SHS		Memi[P2I($1+15)]	# Pointer to SHDR pointers
define	EC_PIXDATA	Memi[P2I($1+16)]	# Pixel coordinates (pointer)
define	EC_FITDATA	Memi[P2I($1+17)]	# Fit coordinates (pointer)

define	EC_IMLINE	Memi[P2I($1+18)]	# Image data (pointer)
define	EC_PIXLINE	Memi[P2I($1+19)]	# Pixel coordinates (pointer)
define	EC_FITLINE	Memi[P2I($1+20)]	# Fit coordinates (pointer)
...
define	EC_APNUM	Memi[P2I($1+26)]	# Aperture number (pointer)
define	EC_LINENUM	Memi[P2I($1+27)]	# Image line number (pointer)
define	EC_ORD		Memi[P2I($1+28)]	# Feature order number (pointer)
define	EC_PIX		Memi[P2I($1+29)]	# Feature pixel coordinates (pointer)
define	EC_FIT		Memi[P2I($1+30)]	# Feature fit coordinates (pointer)
define	EC_USER		Memi[P2I($1+31)]	# Feature user coordinates (pointer)
define	EC_FWIDTHS	Memi[P2I($1+32)]	# Feature width (pointer)
define	EC_FTYPES	Memi[P2I($1+33)]	# Feature type (pointer)

# Current status

define	EC_CURRENT	Memi[P2I($1+34)]	# Current feature
define	EC_SH		Memi[P2I($1+35)]	# Current SHDR pointer
...
define	EC_LP		Memi[P2I($1+39)]	# Logical to physical transformation
define	EC_PL		Memi[P2I($1+40)]	# Physical to logical transformation
define	EC_LL		Memi[P2I($1+41)]	# Linelist pointer
define	EC_ECF		Memi[P2I($1+42)]	# Curfit pointer
define	EC_GP		Memi[P2I($1+43)]	# GIO pointer
define	EC_GT		Memi[P2I($1+44)]	# Gtools pointer
define	EC_UN		Memi[P2I($1+45)]	# Units pointer
...
define	SH		Memi[P2I(EC_SHS($1))+$2-1]

...
define	TWK_SH		Memi[P2I($1+11)]	# Spectrum pointer
define	TWK_CAL		Memi[P2I($1+12)]	# Calibration pointer
define	TWK_WAVE	Memi[P2I($1+13)]	# Pointer to wavelengths
define	TWK_SPEC	Memi[P2I($1+14)]	# Pointer to calibrated spectrum

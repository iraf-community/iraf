...
define	STD_FLAG	Memi[P2I($1+96)]	# Flag
define	STD_BEAM	Memi[P2I($1+97)]	# Beam number of spectrum
define	STD_NPTS	Memi[P2I($1+98)]	# Number of points in spectrum
...
define	STD_NWAVES	Memi[P2I($1+104)]	# Number of calibration wavelengths
define	STD_WAVES	Memi[P2I($1+105)]	# Pointer to wavelengths
define	STD_FLUXES	Memi[P2I($1+106)]	# Pointer to standard flux values
define	STD_DWAVES	Memi[P2I($1+107)]	# Pointer to flux bandwidths
define	STD_COUNTS	Memi[P2I($1+108)]	# Pointer to counts
define	STD_SENS	Memi[P2I($1+109)]	# Pointer to sensitivities
define	STD_FIT		Memi[P2I($1+110)]	# Pointer to fitted sensitivities
define	STD_WTS		Memi[P2I($1+111)]	# Pointer to weights
define	STD_IWTS	Memi[P2I($1+112)]	# Pointer to weights
define	STD_X		Memi[P2I($1+114)]	# Pointer to plotted x values
define	STD_Y		Memi[P2I($1+115)]	# Pointer to plotted y values
...
define	GP_GIO		Memi[P2I($1)]		# GIO pointer
define	GP_TITLE	Memc[P2C($1+1)]		# General title
define	GP_GRAPHS	Memc[P2C($1+41)+$2-1]	# Graphs
define	GP_IMAGES	Memi[P2I($1+44+$2-1)]	# Pointer to image names
define	GP_SKYS		Memi[P2I($1+48+$2-1)]	# Pointer to sky names
define	GP_MARK		Memi[P2I($1+52)]		# Mark type
define	GP_SZMARK	Memr[P2R($1+53)]		# Mark size
define	GP_CMARK	Memi[P2I($1+54)]		# Mark color
define	GP_MDEL		Memi[P2I($1+55)]		# Deleted mark
define	GP_SZMDEL	Memr[P2R($1+56)]		# Size of deleted mark
define	GP_CDEL		Memi[P2I($1+57)]		# Color of deleted mark
define	GP_MADD		Memi[P2I($1+58)]		# Mark type
define	GP_CADD		Memi[P2I($1+59)]		# Mark color
define	GP_PLCOLOR	Memi[P2I($1+60)]		# Line color
define  GP_WSTART       Memr[P2R($1+61)]             # Starting wavelength for plots
define  GP_WEND         Memr[P2R($1+62)]             # Ending wavelength for plots
define	GP_LOG		Memi[P2I($1+63)]		# Log flux plots?
define	GP_FMIN		Memr[P2R($1+64)]		# Minimum flux plot limit
define	GP_FMAX		Memr[P2R($1+65)]		# Maximum flux plot limit
define	GP_SHDR		Memi[P2I($1+65+$2)]		# SHDR pointer

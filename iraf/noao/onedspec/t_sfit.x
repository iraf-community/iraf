...
define	INTERACTIVE	Memi[P2I($1)]		# all spectra are noninteractive
define	REPLACE		Memi[P2I($1+1)]		# replace rejected points?
define	WAVESCALE	Memi[P2I($1+2)]		# X is wavelength if possible
define	LOGSCALE	Memi[P2I($1+3)]		# axes are logarithmic
define	OVERRIDE	Memi[P2I($1+4)]		# allow lines to be redone
define	LISTONLY	Memi[P2I($1+5)]		# don't modify images
define	OUTTYPE		Memi[P2I($1+6)]		# output type code

define	GRAPH_OPEN	Memi[P2I($1+7)]		# keep track of gopen
define	LOG_TO_STDOUT	Memi[P2I($1+8)]		# STDOUT/ERR is used
define	PROMPT		Memi[P2I($1+9)]		# prompt flag
define	QUIET		Memi[P2I($1+10)]		# quiet flag

define	RGIN		Memi[P2I($1+11)]		# lines specified
define	RGFIT		Memi[P2I($1+12)]		# all lines to fit
define	RGREFIT		Memi[P2I($1+13)]		# those to fit again
define	RGINB		Memi[P2I($1+14)]		# bands specified
define	RGFITB		Memi[P2I($1+15)]		# all bands to fit
define	RGREFITB	Memi[P2I($1+16)]		# those to fit again

define	NLOGFD		Memi[P2I($1+17)]		# number of logfiles
define	LOGFD		Memi[P2I($1+18)]		# array of logfiles

define	IC		Memi[P2I($1+19)]		# current ic descriptor
define	YMAX		Memi[P2I($1+20)]		# max number of lines
define	BMAX		Memi[P2I($1+21)]		# max number of lines
define	IC_DESC		Memi[P2I($1+SFT_OFF)+($3-1)*YMAX($1)+$2-1]	# ic descriptors

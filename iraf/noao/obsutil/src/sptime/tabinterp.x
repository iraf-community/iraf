...
define	TAB_PARAMS	Memi[P2I($1+51)]		# Pointer to parameters
define	TAB_NDIM	Memi[P2I($1+52)]		# Dimension of table
define	TAB_INTERP	Memi[P2I($1+53)]		# Interpolation pointer
define	TAB_NEXTRAP	Memi[P2I($1+54)]		# Number of extrapolations
define	TAB_LEN		Memi[P2I($1+55)+$2-1]		# Length of axes in table
define	TAB_COORD	Memi[P2I($1+55)+TAB_DIM+$2-1]	# Pointer to axes coordinates

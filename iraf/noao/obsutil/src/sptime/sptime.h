...
define	ST_NEXP		Memi[P2I($1+8)]		# Number of exposures
...
define	ST_ORDER	Memi[P2I($1+17+$2)]		# Grating orders (2)
define	ST_APSIZE	Memr[P2R($1+19+$2)]		# Aperture sizes (2) 
define	ST_BIN		Memi[P2I($1+21+$2)]		# Binning (2)
...
define	ST_SKYSUB	Memi[P2I($1+29)]		# Sky subtraction type
define	ST_NSKYAPS	Memi[P2I($1+30)]		# Number of sky apertures

define	ST_DISPTYPE	Memi[P2I($1+30+$2)]		# Disperser type
define	ST_GR		Memi[P2I($1+32+$2)]		# Grating pointer (2)
...
define	ST_NOBJPIX	Memi[P2I($1+43)]		# Number of object pixels
define	ST_NSKYPIX	Memi[P2I($1+44)]		# Number of sky pixels
define	ST_APLIM	Memi[P2I($1+45)]		# Aperture limited?
define	ST_APTYPE	Memi[P2I($1+46)]		# Aperture type
define	ST_PIXSIZE	Memr[P2R($1+47)]		# Pixel weighted disp. size
define	ST_FILTBLK	Memi[P2I($1+48)]		# Block filter flag
define	ST_DUNANG	Memi[P2I($1+49)]		# Angstrom units pointer
define	ST_DUN		Memi[P2I($1+50)]		# User units pointer
define	ST_SUBPIXELS	Memi[P2I($1+51)]		# Number of subpixels

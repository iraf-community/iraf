...
define	CT_LW		Memi[P2I($1)]		# MWCS CT (logical -> world)
define	CT_WL		Memi[P2I($1+1)]		# MWCS CT (world -> logical)
define	CT_NX		Memi[P2I($1+2)]		# Number of pixels in X
define	CT_NY		Memi[P2I($1+3)]		# Number of pixels Y

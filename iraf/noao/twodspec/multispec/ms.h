...
define	MS_DB		Memi[P2I($1)]	# DBIO descriptor
define	MS_NAMES	Memi[P2I($1+1)]	# Pointer to database names array
define	MS_DATA		Memi[P2I($1+1+$2)]	# Pointers to data from database

...
define	IDS_NIDS	Memi[P2I($1)]	# Number of aperture IDs
define	IDS_APS		Memi[P2I($1+1)]	# Aperture numbers (pointer)
define	IDS_BEAMS	Memi[P2I($1+2)]	# Beam numbers (pointer)
define	IDS_TITLES	Memi[P2I($1+3)]	# Titles (pointer)

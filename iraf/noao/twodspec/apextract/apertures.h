...
define	AP_ID		Memi[P2I($1)]	# Aperture ID
define	AP_TITLE	Memi[P2I($1+1)]	# Pointer to title
define	AP_BEAM		Memi[P2I($1+2)]	# Aperture beam number
...
define	AP_AXIS		Memi[P2I($1+9)]	# Axis for curve
define	AP_CV		Memi[P2I($1+10)]	# Aperture curve
define	AP_IC		Memi[P2I($1+11)]	# ICFIT pointer
define	AP_SELECT	Memi[P2I($1+12)]	# Aperture selected?

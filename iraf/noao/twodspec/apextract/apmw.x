...
define	APMW_LABEL	Memi[P2I($1)]			# WCS label
define	APMW_UNITS	Memi[P2I($1+1)]			# WCS units
define	APMW_DTYPE	Memi[P2I($1+2)]			# Dispersion type
define	APMW_NW		Memi[P2I($1+3)]			# Number of pixels
define	APMW_W1		Memd[P2D($1+4)]			# Starting coordinate
define	APMW_DW		Memd[P2D($1+6)]			# Coordinate per pixel
define	APMW_AP		Memi[P2I($1+6*($2-1)+8)]	# Aperture
define	APMW_BEAM	Memi[P2I($1+6*($2-1)+9)]	# Beam

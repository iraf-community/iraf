...
define  SR_UNITS	Memi[P2I($1)]    		# Range specifications units
define	SR_COUNT	Memi[P2I($1+1)]		# No. of range sections
define	SR_ERANGE	Memi[P2I($1+2)]		# Array of starting points (ptr)
define	SR_SRANGE	Memi[P2I($1+3)]		# Array of ending points (ptr)
define	SR_NPSAMP	Memi[P2I($1+4)]		# Npts in sample region (ptr)

define	SR_IMTYPE	Memi[P2I($1+5)]		# Image type for sample
define	SR_MODIFY	Memi[P2I($1+6)]		# Sample was modified
define	SR_PARENT	Memi[P2I($1+7)]		# Structure parent pointer

...
# Help files
define	XC_HELP	"noao$base/scr/fxcor.key"	# Help key - FXCOR
define	FM_HELP	"noao$base/scr/fftmode.key"	# Help key - FFT Mode
define	SM_HELP	"noao$base/scr/specmode.key"	# Help key - Spectrum Mode

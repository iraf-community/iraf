...
define	RVP_PLOT		Memi[P2I(RV_PLOTP($1))]	# Plot type
define	RVP_OVERLAY		Memi[P2I(RV_PLOTP($1)+1)]	# Overlay filter?
define	RVP_SPLIT_PLOT		Memi[P2I(RV_PLOTP($1)+2)]	# Make a split-plot?
define	RVP_ONE_IMAGE		Memi[P2I(RV_PLOTP($1)+3)]	# What's in one plot?
define	RVP_WHEN		Memi[P2I(RV_PLOTP($1)+4)]	# Before/after filtering
define	RVP_LOG_SCALE		Memi[P2I(RV_PLOTP($1)+5)]	# Log scale it?
define	RVP_FFT_ZOOM		Memr[RV_PLOTP($1)+6]	# FFT Zoom factor

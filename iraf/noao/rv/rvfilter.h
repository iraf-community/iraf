...
define	RVF_FILTTYPE	     Memi[P2I(RV_FILTP($1))]		# Filter type code
define  RVF_CUTOFF	     Memi[P2I(RV_FILTP($1)+1)]	# Cuton wavenumber
define  RVF_CUTON	     Memi[P2I(RV_FILTP($1)+2)]	# Cuton wavenumber
define  RVF_FULLOFF	     Memi[P2I(RV_FILTP($1)+3)]	# Fulloff wavenumber
define  RVF_FULLON	     Memi[P2I(RV_FILTP($1)+4)]	# Fullon wavenumber

define  RVF_LASTKEY	     Memi[P2I(RV_FILTP($1)+5)]	# Last fftmode comm.

...
define	ID_IMAGE	Memi[P2I($1+1)]	# Image (pointer)
define	ID_SECTION	Memi[P2I($1+2)]	# Section for 2D and 3D images (pointer)
...
define	ID_APS		Memi[P2I($1+9)]	# Array of apertures (pointer)
...
define	ID_DATABASE	Memi[P2I($1+21)]	# Name of database (pointer)
define	ID_COORDLIST	Memi[P2I($1+22)]	# Name of coordinate list (pointer)
define	ID_LL		Memi[P2I($1+23)]	# Pointer to lines in coordinate list
define	ID_LABELS	Memi[P2I($1+24)]	# Type of feature labels
define	ID_LOGFILES	Memi[P2I($1+25)]	# List of logfiles
...
define	ID_IMDATA	Memi[P2I($1+34)]	# Image data (pointer)
define	ID_PIXDATA	Memi[P2I($1+35)]	# Pixel coordinates (pointer)
define	ID_FITDATA	Memi[P2I($1+36)]	# Fit coordinates (pointer)
...
define	ID_PIX		Memi[P2I($1+40)]	# Feature pixel coordinates (pointer)
define	ID_FIT		Memi[P2I($1+41)]	# Feature fit coordinates (pointer)
define	ID_USER		Memi[P2I($1+42)]	# Feature user coordinates (pointer)
define	ID_WTS		Memi[P2I($1+43)]	# Feature weights (pointer)
define	ID_FWIDTHS	Memi[P2I($1+44)]	# Feature width (pointer)
define	ID_FTYPES	Memi[P2I($1+45)]	# Feature type (pointer)
define	ID_LABEL	Memi[P2I($1+46)]	# Feature label (pointer)
define	ID_CURRENT	Memi[P2I($1+47)]	# Current feature

# Pointers for other packages and to save data

define	ID_SH		Memi[P2I($1+48)]	# SHDR pointer
define	ID_LP		Memi[P2I($1+49)]	# Logical to physical transformation
define	ID_PL		Memi[P2I($1+50)]	# Physical to logical transformation
define	ID_IC		Memi[P2I($1+51)]	# ICFIT pointer
define	ID_CV		Memi[P2I($1+52)]	# Curfit pointer
define	ID_GP		Memi[P2I($1+53)]	# GIO pointer
define	ID_GT		Memi[P2I($1+54)]	# Gtools pointer
define	ID_ID		Memi[P2I($1+55)]	# Array of structure pointers (pointer)
define	ID_NID		Memi[P2I($1+56)]	# Number of saved structure
define	ID_DT		Memi[P2I($1+57)]	# Database pointer

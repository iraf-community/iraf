...
define	UN_TYPE		Memi[P2I($1)]		# Unit type code
define	UN_CLASS	Memi[P2I($1+1)]		# Unit class code
define	UN_LOG		Memi[P2I($1+2)]		# Log code
define	UN_INV		Memi[P2I($1+3)]		# Inverse code
...
# Unit abbreviations
define	ABBREVIATIONS	"noao$base/units.dat"

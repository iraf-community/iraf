...
define	TX_XPOS		Memi[P2I($1)]	# x position of start of text
define	TX_YPOS		Memi[P2I($1+1)]	# y position of start of text
define	TX_VALUE	Memi[P2I($1+2)]	# value to write text with
define	PRINT_TEXT	Memi[P2I($1+3)]	# to text, or not to text  (1=yes,0=no)
define	ZERO_BGND	Memi[P2I($1+4)]	# fill background w/ VALU? (1=yes,0=no)
define	BGND_VALU	Memi[P2I($1+5)]	# background value to use

# Vacuum telescope header struture.
define	VT_LENHSTRUCT	10

define	VT_HMONTH	Memi[P2I($1)]	# month of observation (1-12)
define	VT_HDAY		Memi[P2I($1+1)]	# day of observation (1-31)
define	VT_HYEAR	Memi[P2I($1+2)]	# year (two digits)
define	VT_HTIME	Memi[P2I($1+3)]	# time (seconds since midnight)
define	VT_HWVLNGTH	Memi[P2I($1+4)]	# wavelength (angstroms)
define	VT_HOBSTYPE	Memi[P2I($1+5)]	# observation type (0,1,2,3,or 4)
define	VT_HAVINTENS	Memi[P2I($1+6)]	# average intensity
define	VT_HNUMCOLS	Memi[P2I($1+7)]	# number of columns
define	VT_HINTGPIX	Memi[P2I($1+8)]	# integrations per pixel
define	VT_HREPTIME	Memi[P2I($1+9)]	# repitition time

# I/O buffer structure.
define	VT_LENBSTRUCT	3

define	VT_BUFP		Memi[P2I($1)]	# pointer, top of i/o buf
define	VT_BP		Memi[P2I($1+1)]	# pointer, current position in i/o buf
define	VT_BUFBOT	Memi[P2I($1+2)]	# pointer, current bottom of i/o buf

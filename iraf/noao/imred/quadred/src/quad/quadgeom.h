...
define QG_NAMPS		Memi[P2I($1)]	# Total number of active readouts.
define QG_NAMPSX	Memi[P2I($1+1)]	# Number of active readouts in X.
define QG_NAMPSY	Memi[P2I($1+2)]	# Number of active readouts in Y.

# Array of pointers to names of active readouts.
define QG_AMPIDPTR	Memi[P2I($1+3)]			# --> ampid  array.
define QG_AMPID		Memi[QG_AMPIDPTR($1)+$2]	# ampid  array.

# Array of pointers to names of active readouts.
define QG_AMPTYPTR	Memi[P2I($1+4)]			# --> amptype  array.
define QG_AMPTYPE	Memi[QG_AMPTYPTR($1)+$2]	# amptype  array.

# Dimensions of image from each readout.
define QG_NXPTR		Memi[P2I($1+5)]			# --> X dimension array.
define QG_NX		Memi[QG_NXPTR($1)+$2]		# X dimension.
define QG_NYPTR		Memi[P2I($1+6)]			# --> Y dimension array.
define QG_NY		Memi[QG_NYPTR($1)+$2]		# Y dimension.

# datasec = "[dx1:dx2,dy1:dy2]"
define QG_DOFF		7
define QG_DX1PTR	Memi[P2I($1+QG_DOFF)]		# --> dx1 array.
define QG_DX2PTR	Memi[P2I($1+QG_DOFF+1)]		# --> dx2 array.
define QG_DY1PTR	Memi[P2I($1+QG_DOFF+2)]		# --> dy1 array.
define QG_DY2PTR	Memi[P2I($1+QG_DOFF+3)]		# --> dy2 array.
...
define QG_TX1PTR	Memi[P2I($1+QG_TOFF)]		# --> tx1 array.
define QG_TX2PTR	Memi[P2I($1+QG_TOFF+1)]		# --> tx2 array.
define QG_TY1PTR	Memi[P2I($1+QG_TOFF+2)]		# --> ty1 array.
define QG_TY2PTR	Memi[P2I($1+QG_TOFF+3)]		# --> ty2 array.
...
define QG_BX1PTR	Memi[P2I($1+QG_BOFF)]		# --> bx1 array.
define QG_BX2PTR	Memi[P2I($1+QG_BOFF+1)]		# --> bx2 array.
define QG_BY1PTR	Memi[P2I($1+QG_BOFF+2)]		# --> by1 array.
define QG_BY2PTR	Memi[P2I($1+QG_BOFF+3)]		# --> by2 array.
...
define QG_CX1PTR	Memi[P2I($1+QG_COFF)]		# --> cx1 array.
define QG_CX2PTR	Memi[P2I($1+QG_COFF+1)]		# --> cx2 array.
define QG_CY1PTR	Memi[P2I($1+QG_COFF+2)]		# --> cy1 array.
define QG_CY2PTR	Memi[P2I($1+QG_COFF+3)]		# --> cy2 array.
...
define QG_AX1PTR	Memi[P2I($1+QG_AOFF)]		# --> ax1 array.
define QG_AX2PTR	Memi[P2I($1+QG_AOFF+1)]		# --> ax2 array.
define QG_AY1PTR	Memi[P2I($1+QG_AOFF+2)]		# --> ay1 array.
define QG_AY2PTR	Memi[P2I($1+QG_AOFF+3)]		# --> ay2 array.
...
define QG_PHPTR		Memi[P2I($1+QG_PHOFF)]		# --> Phantom array

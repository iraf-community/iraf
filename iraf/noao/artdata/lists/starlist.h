...
define	ST_TYPE			Memi[P2I($1)]	# Stars or galaxies
define	ST_SPATIAL		Memi[P2I($1+1)]	# Spatial function
...
define	ST_LUMINOSITY		Memi[P2I($1+10)]	# Luminosity function
...
define	ST_SSEED		Meml[P2L($1+25)]	# Spatial function seed
define	ST_LSEED		Meml[P2L($1+26)]	# Luminosity function seed
define	ST_NSSAMPLE		Memi[P2I($1+27)]	# Spatial function sampling
define	ST_NLSAMPLE		Memi[P2I($1+28)]	# Luminosity function sampling
define	ST_SORDER		Memi[P2I($1+29)]	# Spatial spline order
define	ST_LORDER		Memi[P2I($1+30)]	# Luminosity spline order
define	ST_NSTARS		Memi[P2I($1+31)]	# Number of stars

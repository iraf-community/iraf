...
define	LEN_MKT		18
define	MKT_PROF	Memi[P2I($1)]	# Pointer to profile
define	MKT_MSI		Memi[P2I($1+1)]	# MSI interpolation pointer
define	MKT_NXM		Memi[P2I($1+2)]	# Number of X points in model
define	MKT_NYM		Memi[P2I($1+3)]	# Number of Y points in model
define	MKT_F		Memr[P2R($1+4)]	# Fraction of total flux in profile
define	MKT_SCALE	Memr[P2R($1+5)]	# Radius scale

define	MKT_NALLOC	Memi[P2I($1+6)]	# Allocated space for saved templates
define	MKT_N		Memi[P2I($1+7)]	# Number of saved templates

define	MKT_DATA	Memi[P2I($1+8)]	# Data pointer
define	MKT_PTRS	Memi[P2I($1+9)]	# Data pointers
define	MKT_NX		Memi[P2I($1+10)]	# Number of X pixels
define	MKT_NY		Memi[P2I($1+11)]	# Number of Y pixels
define	MKT_XC		Memi[P2I($1+12)]	# Subpixel X center
define	MKT_YC		Memi[P2I($1+13)]	# Subpixel Y center
define	MKT_FLUX	Memi[P2I($1+14)]	# Flux
define	MKT_R		Memi[P2I($1+15)]	# Radius
define	MKT_AR		Memi[P2I($1+16)]	# Axial ratio
define	MKT_PA		Memi[P2I($1+17)]	# Position angle

...
define	LEN_MKO		9
define	MKO_MKT		Memi[P2I($1)]		# Template
define	MKO_X		Memi[P2I($1+1)]		# X position
define	MKO_Y		Memi[P2I($1+2)]		# Y position
define	MKO_Z		Memi[P2I($1+3)]		# Flux
define	MKO_R		Memi[P2I($1+4)]		# Scale size
define	MKO_AR		Memi[P2I($1+5)]		# Axial ratio
define	MKO_PA		Memi[P2I($1+6)]		# Position angle
define	MKO_SAVE	Memi[P2I($1+7)]		# Save template?
define	MKO_SORT	Memi[P2I($1+8)]		# Sort index

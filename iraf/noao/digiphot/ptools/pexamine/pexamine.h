...
define	PX_RNPHOT	Memi[P2I($1)]	# number of req'd photometry columns
define	PX_RNUSER	Memi[P2I($1+1)]	# number of req'd user columns
define	PX_RNCOLS	Memi[P2I($1+2)]	# total number of req'd columns
define	PX_RCOLNAMES	Memi[P2I($1+3)]      # ptr to list of req'd column names
define	PX_NPHOT	Memi[P2I($1+4)]	# number of photometry columns
define	PX_NUSER	Memi[P2I($1+5)]	# number of user columns
define	PX_NCOLS	Memi[P2I($1+6)]	# total number of stored columns
define	PX_COLNAMES	Memi[P2I($1+7)]      # ptr to list of stored column names
define 	PX_COLPTRS	Memi[P2I($1+8)]	# ptr to array of stored column pointers

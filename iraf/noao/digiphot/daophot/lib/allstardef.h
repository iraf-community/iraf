...
define	DP_SNX		Memz[P2Z($1+14)]	# subt x dimension
define	DP_SNY		Memz[P2Z($1+15)]	# subt y dimension
define	DP_SLX		Meml[P2L($1+16)]	# subt lower left x coord
define	DP_SMX		Meml[P2L($1+17)]	# subt lower right x coord
define	DP_SLY		Meml[P2L($1+18)]	# subt lower left y coord
define	DP_SMY		Meml[P2L($1+19)]	# subt lower right y coord
define	DP_SXOFF	Meml[P2L($1+20)]	# subt lower left x offset
define	DP_SYOFF	Meml[P2L($1+21)]	# subt lower left y offset

define	DP_WBUF		Memp[$1+23]	# local weight buffer
define	DP_WNX		Memz[P2Z($1+24)]	# weight x dimension
define	DP_WNY		Memz[P2Z($1+25)]	# weight y dimension
define	DP_WLX		Meml[P2L($1+26)]	# weight lower left x coord
define	DP_WMX		Meml[P2L($1+27)]	# weight lower right x coord
define	DP_WLY		Meml[P2L($1+28)]	# weight lower left y coord
define	DP_WMY		Meml[P2L($1+29)]	# weight lower right y coord
define	DP_WXOFF	Meml[P2L($1+30)]	# weight lower left x offset
define	DP_WYOFF	Meml[P2L($1+31)]	# weight lower left y offset

define	DP_DBUF		Memp[$1+33]	# local weight buffer
define	DP_DNX		Memz[P2Z($1+34)]	# weight x dimension
define	DP_DNY		Memz[P2Z($1+35)]	# weight y dimension
define	DP_DLX		Meml[P2L($1+36)]	# weight lower left x coord
define	DP_DMX		Meml[P2L($1+37)]	# weight lower right x coord
define	DP_DLY		Meml[P2L($1+38)]	# weight lower left y coord
define	DP_DMY		Meml[P2L($1+39)]	# weight lower right y coord
define	DP_DXOFF	Meml[P2L($1+40)]	# weight lower left x offset
define	DP_DYOFF	Meml[P2L($1+41)]	# weight lower left y offset

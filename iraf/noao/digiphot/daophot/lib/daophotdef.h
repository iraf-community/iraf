...
define	DP_VARORDER	Memi[P2I($1+17)]	# order of psf variability
define	DP_FEXPAND	Memi[P2I($1+18)]	# expand the analytic function ?
define	DP_SATURATED	Memi[P2I($1+19)]	# use saturated psf stars ?
define	DP_NCLEAN	Memi[P2I($1+20)]	# number of psf cleaning passes
define	DP_MAXNSTAR	Memi[P2I($1+21)]	# maximum number of stars
define	DP_MAXGROUP	Memi[P2I($1+22)]	# maximum group size
define	DP_MAXITER	Memi[P2I($1+23)]	# maximum number of iterations
define	DP_RECENTER	Memi[P2I($1+24)]	# recenter ?
define	DP_FITSKY	Memi[P2I($1+25)]	# fit the sky ?
define	DP_GROUPSKY	Memi[P2I($1+26)]	# use the group sky value ?
define	DP_CLIPEXP	Memi[P2I($1+27)]	# clip exponent
define	DP_TEXT		Memi[P2I($1+28)]	# text file or table input/output ?
define	DP_VERBOSE	Memi[P2I($1+29)]	# verbose mode ?

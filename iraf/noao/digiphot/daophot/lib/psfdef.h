...
define	DP_CUR_PSF	Memi[P2I($1+27)]	# position of current PSF star in file
define	DP_CUR_PSFID	Memi[P2I($1+28)]	# id of current PSF star
...
define	DP_PLOTTYPE	Memi[P2I($1+36)]	# type of PSF plot

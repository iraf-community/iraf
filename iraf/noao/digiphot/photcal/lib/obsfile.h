...
define	IMT_IMSETNO	Memi[P2I($1)]		     # the image set id number
define	IMT_IMNO	Memi[P2I($1+1)]		     # the image sequence number
define	IMT_OFFSET	Memi[P2I($1+2)]		     # offset to image data
define	IMT_NENTRIES	Memi[P2I($1+3)]		     # number of data entries 

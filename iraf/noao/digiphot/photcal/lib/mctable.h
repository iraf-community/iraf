...
define	MCT_MAGIC	Memi[P2I($1+0)]		# magic number
define	MCT_TYPE	Memi[P2I($1+1)]		# table data type
define	MCT_MAXROW	Memi[P2I($1+2)]		# max number of rows (growing)
define	MCT_MAXCOL	Memi[P2I($1+3)]		# max number of columns (fixed)
define	MCT_INCROWS	Memi[P2I($1+4)]		# row growing increment
define	MCT_NPROWS	Memi[P2I($1+5)]		# highest row entered

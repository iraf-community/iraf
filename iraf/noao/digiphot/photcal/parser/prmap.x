...
define	TABLE_MIN	Memi[P2I($1+0)]	# minimum column number
define	TABLE_MAX	Memi[P2I($1+1)]	# maximum column number
define	TABLE_NVARS	Memi[P2I($1+2)]	# number of variables
define	TABLE_PCOLS	Memi[P2I($1+3)]	# pointer to column indices
define	TABLE_PNCOLS	Memi[P2I($1+4)]	# pointer to column indices count

...
define	KY_NKEYS	Memi[P2I($1)]	# total number of keys
define	KY_NPKEYS	Memi[P2I($1+1)]	# number of parameter keys
define	KY_NSTORE	Memi[P2I($1+2)]	# amount of storage space for keys
#define	KY_NOKEYS	Memi[P2I($1+3)]	# number of defined keys before table

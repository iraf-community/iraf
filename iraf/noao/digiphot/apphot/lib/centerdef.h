...
define	AP_CENTERFUNCTION   Memi[P2I($1)]	# Centering algorithm
...
define	AP_CLEAN	    Memi[P2I($1+5)]	# Clean before centering
...
define	AP_CMAXITER	    Memi[P2I($1+9)]	# Maximum number of iterations

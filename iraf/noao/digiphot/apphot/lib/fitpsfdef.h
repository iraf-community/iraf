...
define	AP_PSFNPARS	Memi[P2I($1+1)]	# Number of parameters
define	AP_MAXNPARS	Memi[P2I($1+2)]	# Maximum number of parameters
...
define	AP_PSFPIX	Memi[P2I($1+7)]	# Pointer to pixels
define	AP_PSFXPIX	Memi[P2I($1+8)]	# X coordinates array (not used)
define	AP_PSFYPIX	Memi[P2I($1+9)]	# Y coordinates array (not used)
define	AP_NPSFPIX	Memi[P2I($1+10)]	# Number of pixels (not used)
define	AP_LENPSFBUF	Memi[P2I($1+11)]	# Length of pixel buffer (not used)
define	AP_PXC		Memr[P2R($1+12)]	# X center of subraster
define	AP_PYC		Memr[P2R($1+13)]	# Y center of subraster
define	AP_PNX		Memi[P2I($1+14)]	# X dimension of subraster
define	AP_PNY		Memi[P2I($1+15)]	# Y dimension of subraster
...
define	AP_PPARS	Memi[P2I($1+20)]	# fitted parameters
define	AP_PPERRS	Memi[P2I($1+21)]	# errors in the parameters

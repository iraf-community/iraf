...
define	AP_SKYPIX	Memi[P2I($1+14)]	# pointer to sky pixels
define	AP_INDEX	Memi[P2I($1+15)]	# pointer to ordering array
define	AP_COORDS	Memi[P2I($1+16)]	# pointer to sky coordinates array
define	AP_SWGT		Memi[P2I($1+17)]	# pointer to sky weights
define	AP_NSKYPIX	Memi[P2I($1+18)]	# number of sky pixels
define	AP_NBADSKYPIX	Memi[P2I($1+19)]	# number of bad sky pixels
define	AP_LENSKYBUF	Memi[P2I($1+20)]	# length of sky buffers
...
define	AP_SNX		Memi[P2I($1+25)]	# x dimension of sky subraster
define	AP_SNY		Memi[P2I($1+26)]	# y dimension of sky subraster
...
define	AP_NSKY		Memi[P2I($1+32)]	  # number of sky pix
define	AP_NSKY_REJECT	Memi[P2I($1+33)]	  # number of rejected sky pix

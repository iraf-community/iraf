...
define	AP_RPIX		Memi[P2I($1+2)]	# Pointer to radial profile pixels
define	AP_RPXC		Memr[P2R($1+3)]	# X center of subraster
define	AP_RPYC		Memr[P2R($1+4)]	# Y center of subraster
define	AP_RPNX		Memi[P2I($1+5)]	# Subraster length in x
define	AP_RPNY		Memi[P2I($1+6)]	# Subraster length in y
...
define	AP_RPNPTS	Memi[P2I($1+14)]	# Number of points in radial profile
define	AP_RPDIST	Memi[P2I($1+15)]	# Pointer to radial distance array
define	AP_INTENSITY	Memi[P2I($1+16)]	# Pointer to fitted intensity array
define	AP_DINTENSITY	Memi[P2I($1+17)]	# Pointer incremental intensity array
define	AP_TINTENSITY	Memi[P2I($1+18)]	# Pointer to total intensity array
...
define	AP_RPNDATA	Memi[P2I($1+23)]	# Number of data points
define	AP_RPNDATAREJ	Memi[P2I($1+24)]	# Number of points rejected from fit
define	AP_RPNBAD	Memi[P2I($1+25)]	# Number of bad pixel points

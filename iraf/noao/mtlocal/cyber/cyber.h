...
define	BITS_PIXEL	Memi[P2I($1)]
define	PRU_EOR         Memi[P2I($1+1)]
define	WRDS_PER_ROW    Memi[P2I($1+2)]
define	NPRU_ROW	Memi[P2I($1+3)]
define	PRU_ROW_ONE     Memi[P2I($1+4)]
define	NCOLS		Memi[P2I($1+5)]
define	NROWS		Memi[P2I($1+6)]
...
define	CY		Memi[P2I($1)]
define	M_CREATE	Memi[P2I($1+1)]
define	D_CREATE	Memi[P2I($1+2)]
define	Y_CREATE	Memi[P2I($1+3)]
define	M_ALTER		Memi[P2I($1+4)]
define	D_ALTER		Memi[P2I($1+5)]
define	Y_ALTER		Memi[P2I($1+6)]
define	M_ATTACH	Memi[P2I($1+7)]
define	D_ATTACH	Memi[P2I($1+8)]
define	Y_ATTACH	Memi[P2I($1+9)]
define	NCHARS_PFN	Memi[P2I($1+10)]
...
define	MAKE_IMAGE		Memi[P2I($1)]
define	PRINT_PIXELS		Memi[P2I($1+1)]
define	LONG_HEADER		Memi[P2I($1+2)]
define	DATA_TYPE		Memi[P2I($1+3)]
...
define	RECORD_NUMBER		Memi[P2I($1+12)]
define	ITM			Memi[P2I($1+13)]
define	NP1			Memi[P2I($1+14)]
define	NP2			Memi[P2I($1+15)]
define	BEAM_NUMBER		Memi[P2I($1+16)]

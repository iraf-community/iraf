...
define	FL_NEXPR	Memi[P2I($1)]	# The number of input expressions
define	FL_NFIELDS	Memi[P2I($1+1)]	# The number of output fields

# The field list decription
define	FL_FLIST	Memi[P2I($1+2)]	# The list of field expressions
define	FL_FRANGES	Memi[P2I($1+3)]	# The list of field ranges

# New quantities to be written in the header (could be a symbol table ...)
define	FL_FNAMES	Memi[P2I($1+4)]	# The list of field names
define	FL_FOFFSETS	Memi[P2I($1+5)]	# The list of field offsets
define	FL_FSIZES	Memi[P2I($1+6)]	# The list of field sizes
define	FL_FTYPES	Memi[P2I($1+7)]      # The list of field types
define	FL_FUNITS	Memi[P2I($1+8)]	# The list of field units
define	FL_FFMTS	Memi[P2I($1+9)]	# The list of field formats

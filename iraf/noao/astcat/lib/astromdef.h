...
define	AT_PIO		Memi[P2I($1)]	     # the i/o structure
define	AT_PRCENTER	Memi[P2I($1+1)]	     # the region definition structure
define	AT_PFILTER 	Memi[P2I($1+2)]	     # the catalog filtering structure
define	AT_PWCS 	Memi[P2I($1+3)]	     # the image wcs structure
define	AT_PIMPARS 	Memi[P2I($1+4)]	     # the image data structure
...
define  AT_RCRAUNITS  Memi[P2I($1+8)]              # the ra / lon units
define  AT_RCDECUNITS Memi[P2I($1+9)]              # the dec / lat units
#define	AT_RCCC	      Memi[P2I($1+10)]             # the field center cc structure
define	AT_RCST	      Memi[P2I($1+11)]             # the field center symbol table
...
define	AT_FREVERSE	Memi[P2I($1)]
define	AT_FREPLACE	Memi[P2I($1+1)]
define	AT_FORAUNITS	Memi[P2I($1+2)]
define	AT_FODECUNITS	Memi[P2I($1+3)]

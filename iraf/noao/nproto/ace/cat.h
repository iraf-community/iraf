...
define	CAT_OBJS	Memi[P2I($1)]	# Array of objects (ptr)
define	CAT_APFLUX	Memi[P2I($1+1)]	# Array of aperture fluxes (ptr)
define	CAT_NOBJS	Memi[P2I($1+2)]	# Number of objects
define	CAT_NUMMAX	Memi[P2I($1+3)]	# Maximum object number
define	CAT_FLAGS	Memi[P2I($1+4)]	# Catalog flags
define	CAT_HDR		Memi[P2I($1+5)]	# Header structure
define	CAT_INTBL	Memi[P2I($1+6)]	# Input table structure
define	CAT_OUTTBL	Memi[P2I($1+7)]	# Output table structure
...
# Table structure.
define	TBL_LEN		2
define	TBL_TP		Memi[P2I($1)]	# Table pointer
define	TBL_STP		Memi[P2I($1+1)]	# Symbol table of entries
...
define	ENTRY_CDEF	Memi[P2I($1)]		# Column descriptor
define	ENTRY_ID	Memi[P2I($1+1)]		# Entry id
define	ENTRY_TYPE	Memi[P2I($1+2)]		# Datatype in object record
define	ENTRY_CTYPE	Memi[P2I($1+3)]		# Datatype in catalog
define	ENTRY_FUNC	Memi[P2I($1+4)]		# Entry function

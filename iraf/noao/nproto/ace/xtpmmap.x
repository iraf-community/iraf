...
pointer	im, pm
int	errcode()
pointer	im_pmmap(), yt_pmimmap(), yt_pmtext(), yt_pmsection(), imstatp()
bool	streq()
errchk	yt_match
...
int	imgnli()
pointer immap(), pm_newmask(), im_pmmapo(), imgl1i(), mw_openim(), imstatp()
...
double	mw_c1trand()
pointer	pm_open(), mw_openim(), im_pmmapo(), imgl1i(), mw_sctran(), imstatp()

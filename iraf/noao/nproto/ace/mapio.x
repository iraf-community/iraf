...
define	MAP_TYPE	Memi[P2I($1+51)]	# Type of map
define	MAP_MAP		Memi[P2I($1+52)]	# Structure pointer
define	MAP_COPY	Memi[P2I($1+53)]	# Data buffer for copy
define	MAP_NC		Memi[P2I($1+54)]	# Number of columns
define	MAP_NL		Memi[P2I($1+55)]	# Number of columns
define	MAP_SAMPLE	Memi[P2I($1+56)]	# Sample size for lines
define	MAP_BUF		Memi[P2I($1+57)]	# Data buffer for constant or sampling
define	MAP_BUF1	Memi[P2I($1+58)]	# Data buffer for sampling
define	MAP_BUF2	Memi[P2I($1+59)]	# Data buffer for sampling
define	MAP_LINE1	Memi[P2I($1+60)]	# Sampling line number
define	MAP_LINE2	Memi[P2I($1+61)]	# Sampling line number
define	MAP_LASTLINE	Memi[P2I($1+62)]	# Last line
define	MAP_LASTBUF	Memi[P2I($1+63)]	# Data buffer last returned

...
# Data structure.
define	MIM_LEN		18
define	MIM_INTERP	Memi[P2I($1)]	# Use interpolation?
define	MIM_ROTATE	Memi[P2I($1+1)]	# Is there any rotation?
define	MIM_IM		Memi[P2I($1+2)]	# IMIO mim pointer
define	MIM_MSI		Memi[P2I($1+3)]	# MSI interpolation pointer
define	MIM_NCREF	Memi[P2I($1+4)]	# Number of columns in ref image
define	MIM_NC		Memi[P2I($1+5)]	# Number of columns in input image
define	MIM_NL		Memi[P2I($1+6)]	# Number of lines in input image
define	MIM_LINE1	Memi[P2I($1+7)]	# First line in msi fit
define	MIM_LINE2	Memi[P2I($1+8)]	# Last line in msi fit
define	MIM_X		Memi[P2I($1+9)]	# Pointer to line of x values
define	MIM_Y		Memi[P2I($1+10)]	# Pointer to line of y values
define	MIM_Z		Memi[P2I($1+11)]	# Pointer to line of z values
define	MIM_MW		Memi[P2I($1+12)]	# MWCS pointer
define	MIM_CT		Memi[P2I($1+13)]	# CT from ref logical to input logical
define	MIM_MSITYPE	Memi[P2I($1+14)]	# MSI interpolation type
define	MIM_MSIEDGE	Memi[P2I($1+15)]	# Number of edge pixels to reserve
define	MIM_MSIMAX	Memi[P2I($1+16)]	# Maximum number of pixels in msi fit
define	MIM_DELETE	Memi[P2I($1+17)]	# Delete image after closing?

...
define	SKF_FUNC1D	Memi[P2I($1+2)]	# 1D Fitting function
define	SKF_FUNC2D	Memi[P2I($1+3)]	# 2D Fitting function
define	SKF_XORDER	Memi[P2I($1+4)]	# Sky fitting x order
define	SKF_YORDER	Memi[P2I($1+5)]	# Sky fitting y order
define	SKF_XTERMS	Memi[P2I($1+6)]	# Sky fitting cross terms
define	SKF_BLK1D	Memi[P2I($1+7)]	# Sky block size for 1D averages
define	SKF_HCLIP	Memr[P2R($1+8)]	# Sky fitting high sigma clip
define	SKF_LCLIP	Memr[P2R($1+9)]	# Sky fitting low sigma clip
define	SKF_NITER	Memi[P2I($1+10)]	# Number of iterations

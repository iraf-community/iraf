...
define	DET_HDETECT	Memi[P2I($1+53)]	# Detect above sky?
define	DET_LDETECT	Memi[P2I($1+54)]	# Detect below sky?
define	DET_NEIGHBORS	Memi[P2I($1+55)]	# Neighbor type
define	DET_MINPIX	Memi[P2I($1+56)]	# Minimum number of pixels
...
define	DET_BPVAL	Memi[P2I($1+60)]	# Output bad pixel value
define	DET_SKB		Memi[P2I($1+61)]	# Parameters for sky update

...
define	MGS_GS		Memi[P2I($1)]	# GSURFIT pointer
define	MGS_X		Memi[P2I($1+1)]	# Pointer to line of x values
define	MGS_Y		Memi[P2I($1+2)]	# Pointer to line of y values
define	MGS_Z		Memi[P2I($1+3)]	# Pointer to line of z values
define	MGS_NC		Memi[P2I($1+4)]	# Number of columns
define	MGS_REFIM	Memi[P2I($1+5)]	# Reference image pointer

...
define	SPT_NEIGHBORS	Memi[P2I($1)]	# Neighbor type
...
define	SPT_MINPIX	Memi[P2I($1+4)]	# Minimum number of pixels
...
define	SPT_SMINPIX	Memi[P2I($1+7)]	# Minimum number of split pixels

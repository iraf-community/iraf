...
define	RMOD_NRING	Memi[P2I($1)]    # the number of elements in the filter
define  RMOD_NLOW	Memz[P2Z($1+1)]  # number of low rejected pixels
define  RMOD_NHIGH	Memz[P2Z($1+2)]  # number of high rejected pixels

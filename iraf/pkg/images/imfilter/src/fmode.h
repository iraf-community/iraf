...
define	FMOD_XBOX	Memi[P2I($1)]    # x median filtering window
define	FMOD_YBOX	Memi[P2I($1+1)]  # y median filtering window
...
define	FMOD_NMEDIAN	Memi[P2I($1+10)] # number less than the median
define	FMOD_NLTMEDIAN	Memi[P2I($1+11)] # number less than the current median

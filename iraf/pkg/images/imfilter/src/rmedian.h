...
define	RMED_NRING	Memi[P2I($1)]    # the number of elements in the filter
define  RMED_NLOW	Memi[P2I($1+1)]  # number of low rejected pixels
define  RMED_NHIGH	Memi[P2I($1+2)]  # number of high rejected pixels

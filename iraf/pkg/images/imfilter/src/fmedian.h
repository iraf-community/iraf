...
define	FMED_XBOX	Memz[P2Z($1)]    # x median filtering window
define	FMED_YBOX	Memz[P2Z($1+1)]  # y median filtering window
...
define	FMED_NMEDIAN	Meml[P2L($1+10)]  # number less than the median
define	FMED_NLTMEDIAN	Meml[P2L($1+11)]  # number less than the current median

...
define	RM_RMS		Memi[P2I($1)]	# Pointer to RMEDSRT method
...
define	RM_GOOD		Memi[P2I($1+4)]	# Ptr to good array (box)
define	RM_MASK		Memi[P2I($1+5)]	# Ptr to mask array
define	RM_PWIN		Memi[P2I($1+6)]	# Ptr to packed window data (n*box)
define	RM_POUT		Memi[P2I($1+7)]	# Ptr to packed outlist data (n*box)
define	RM_PMASK	Memi[P2I($1+8)]	# Ptr to mask data (n*(box+15)/16)
...
real procedure rm_med (rm, navg, blank, exclude, index, in, mask, nused)
...
real procedure rm_gmed (rm, navg, blank, exclude, nused)

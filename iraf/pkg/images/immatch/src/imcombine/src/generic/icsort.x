...
size_t	npts			# number of points in vectors

short	pivot, temp, temp3
long	l
int	i, j, k, p, npix, lv[LOGPTR], uv[LOGPTR]
...
short	pivot, temp, temp3
long	l
int	i, j, k, p, npix, lv[LOGPTR], uv[LOGPTR], itemp
define	swap {temp=$1;$1=$2;$2=temp}
...
procedure ic_sortl (a, b, nvecs, npts)

pointer	a[ARB]			# pointer to input vectors
long	b[ARB]			# work array
int	nvecs[npts]		# number of vectors
size_t	npts			# number of points in vectors

long	pivot, temp, temp3
long	l
int	i, j, k, p, npix, lv[LOGPTR], uv[LOGPTR]
define	swap {temp=$1;$1=$2;$2=temp}
define	copy_	10
...
procedure ic_2sortl (a, b, c, d, nvecs, npts)

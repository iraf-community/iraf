...
define	GT_GEOMODE		Memi[P2I($1+8)]	# Type of transformation
...
define	GT_INTERPOLANT		Memi[P2I($1+21)]	# image interpolant
define	GT_NSINC		Memi[P2I($1+22)]	# sinc width half-width
define	GT_NXYMARGIN		Memi[P2I($1+23)]	# the interpolation margin
define	GT_BOUNDARY		Memi[P2I($1+24)]	# boundary extension
define	GT_CONSTANT		Memr[P2R($1+25)]	# constant boundary extension
define	GT_FLUXCONSERVE		Memi[P2I($1+26)]	# conserve total flux

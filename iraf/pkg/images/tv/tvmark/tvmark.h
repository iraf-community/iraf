...
define	MK_AUTOLOG	Memi[P2I($1)]	# Enable auto logging
define	MK_NUMBER	Memi[P2I($1+1)]	# Number coordinate list entries
define	MK_LABEL	Memi[P2I($1+2)]	# Label coordinate list entries
define	MK_GRAYLEVEL	Memi[P2I($1+3)]	# Gray level of marks
define	MK_SIZE		Memi[P2I($1+4)]	# Size of numbers and text
define	MK_FRAME	Memi[P2I($1+5)]	# Frame number for display
define	MK_NCIRCLES	Memi[P2I($1+6)]	# Number of circles
define	MK_NELLIPSES	Memi[P2I($1+7)]	# Number of ellipses
define	MK_NSQUARES	Memi[P2I($1+8)]	# Number of squares

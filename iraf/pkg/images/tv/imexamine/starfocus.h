...
define	SF_NCOLS	Memi[P2I($1+15)]	# Number of image columns
define	SF_NLINES	Memi[P2I($1+16)]	# Number of image lines
define	SF_XF		Memr[P2R($1+17)]	# X field center
define	SF_YF		Memr[P2R($1+18)]	# Y field center
define	SF_GP		Memi[P2I($1+19)]	# GIO pointer
...
define	SF_SFDS		Memi[P2I($1+29)]	# Pointer to data structures
define	SF_NS		Memi[P2I($1+30)]	# Number of stars not deleted
define	SF_NSTARS	Memi[P2I($1+31)]	# Number of stars
define	SF_STARS	Memi[P2I($1+32)]	# Pointer to star groups
define	SF_NF		Memi[P2I($1+33)]	# Number of focuses not deleted
define	SF_NFOCUS	Memi[P2I($1+34)]	# Number of different focus values
define	SF_FOCUS	Memi[P2I($1+35)]	# Pointer to focus groups
define	SF_NI		Memi[P2I($1+36)]	# Number of images not deleted
define	SF_NIMAGES	Memi[P2I($1+37)]	# Number of images
define	SF_IMAGES	Memi[P2I($1+38)]	# Pointer to image groups
define	SF_BEST		Memi[P2I($1+39)]	# Pointer to best focus star

define	SF_SFD		Memi[P2I(SF_SFDS($1))+$2-1]
define	SF_SFS		Memi[P2I(SF_STARS($1))+$2-1]
define	SF_SFF		Memi[P2I(SF_FOCUS($1))+$2-1]
define	SF_SFI		Memi[P2I(SF_IMAGES($1))+$2-1]

# Basic data structure.
define	SFD		94
define	SFD_IMAGE	Memc[P2C($1)]	# Image name
define	SFD_DATA	Memi[P2I($1+40)]	# Pointer to real image raster
define	SFD_RADIUS	Memr[P2R($1+41)]	# Profile radius
define	SFD_NP		Memi[P2I($1+42)]	# Number of profile points
define	SFD_NPMAX	Memi[P2I($1+43)]	# Maximum number of profile points
define	SFD_X1		Memi[P2I($1+44)]	# Image raster limits
define	SFD_X2		Memi[P2I($1+45)]
define	SFD_Y1		Memi[P2I($1+46)]
define	SFD_Y2		Memi[P2I($1+47)]
...
define	SFD_ASI1	Memi[P2I($1+60)]	# Pointer to enclosed flux profile
define	SFD_ASI2	Memi[P2I($1+61)]	# Pointer to derivative profile
...
define	SFD_NSAT	Memi[P2I($1+90)]	# Number of saturated pixels
define	SFD_SFS		Memi[P2I($1+91)]	# Pointer to star group
define	SFD_SFF		Memi[P2I($1+92)]	# Pointer to focus group
define	SFD_SFI		Memi[P2I($1+93)]	# Pointer to image group
...
define	SFS_SFD		Memi[P2I($1+$2+6)]	# Array of data structures
...
define	SFF_SFD		Memi[P2I($1+$2+4)]	# Array of data structures
...
define	SFI_SFD		Memi[P2I($1+$2+41)]	# Array of data structures

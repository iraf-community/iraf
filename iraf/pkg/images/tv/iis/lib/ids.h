...
define	IDS_SBUF	Memi[P2I($1)]		# string buffer
define	IDS_SZSBUF	Memi[P2I($1+1)]		# size of string buffer
define	IDS_NEXTCH	Memi[P2I($1+2)]		# next char pos in string buf
define	IDS_NCHARSIZES	Memi[P2I($1+3)]		# number of character sizes
define	IDS_POLYLINE	Memi[P2I($1+4)]		# device supports polyline
define	IDS_POLYMARKER	Memi[P2I($1+5)]		# device supports polymarker
define	IDS_FILLAREA	Memi[P2I($1+6)]		# device supports fillarea
define	IDS_CELLARRAY	Memi[P2I($1+7)]		# device supports cell array
define	IDS_ZRES	Memi[P2I($1+8)]		# device resolution in Z
define	IDS_FILLSTYLE	Memi[P2I($1+9)]		# number of fill styles
define	IDS_ROAM	Memi[P2I($1+10)]		# device supports roam
define	IDS_CANZM	Memi[P2I($1+11)]		# device supports zoom
define	IDS_SELERASE	Memi[P2I($1+12)]		# device has selective erase
define	IDS_FRAME	Memi[P2I($1+13)]		# pointer to frames area
define	IDS_BITPL	Memi[P2I($1+14)]		# pointer to bitplane area
	# extra space
define	IDS_FRCOLOR	Memi[P2I($1+18)]		# frame color
define	IDS_GRCOLOR	Memi[P2I($1+19)]		# graphics color
define	IDS_LCURSOR	Memi[P2I($1+20)]		# last cursor accessed
define	IDS_COLOR	Memi[P2I($1+21)]		# last color set
define	IDS_TXSIZE	Memi[P2I($1+22)]		# last text size set
define	IDS_TXFONT	Memi[P2I($1+23)]		# last text font set
define	IDS_TYPE	Memi[P2I($1+24)]		# last line type set
define	IDS_WIDTH	Memi[P2I($1+25)]		# last line width set
define	IDS_DEVNAME	Memi[P2I($1+26)]		# name of open device
define	IDS_CHARHEIGHT	Memi[P2I($1+30+$2-1)]	# character height
define	IDS_CHARWIDTH 	Memi[P2I($1+40+$2-1)]	# character width

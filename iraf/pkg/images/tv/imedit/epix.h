...
define	EP_APERTURE	Memi[P2I($1+352)]		# Aperture type
define	EP_AUTODISPLAY	Memi[P2I($1+353)]		# Automatic image display?
define	EP_AUTOSURFACE	Memi[P2I($1+354)]		# Automatic surface plots?
define	EP_BUFFER	Memr[P2R($1+355)]		# Background buffer width
define	EP_DEFAULT	Memi[P2I($1+356)]		# Default edit option
define	EP_DISPLAY	Memi[P2I($1+357)]		# Display images?
define	EP_FIXPIX	Memi[P2I($1+358)]		# Fixpix input?
...
define	EP_XORDER	Memi[P2I($1+366)]		# Background xorder

...
define	GG_NEWFUNCTION		Memi[P2I($1)]	# New function
define	GG_PLOTTYPE		Memi[P2I($1+1)]	# Type of plot
define	GG_OVERPLOT		Memi[P2I($1+2)]	# Overplot previous graph?
define	GG_FITERROR		Memi[P2I($1+3)]	# Error fitting x function
define	GG_CONSTXY		Memi[P2I($1+4)]	# Plot lines of constant x-y

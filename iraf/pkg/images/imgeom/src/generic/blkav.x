...
size_t	sz_val
long	l_val
size_t	num_oblks[IM_MAXDIM]
int	ndim, dim
size_t	nfull_blkx, num_ilines, num_olines, nlines_in_sum
long	i, count, junk, oline
...
begin
	...
	do oline = 1, num_olines {
	    ...
	    if (option == AVG) {
		l_val = nlines_in_sum
		call adivkl (Meml[oline_ptr], l_val,

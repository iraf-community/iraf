...
define	VPTR		Memp[$1+$2-1]	# Array of axis vector pointers
...
long	l_val
int	image
long	i, line, nlines, nbands, stat, cum_len
...
begin
	...
	call smark (sp)
	sz_val = nimages
	call salloc (vin, sz_val, TY_POINTER)
	sz_val = IM_MAXDIM
	...
	do image = 1, nimages {
	    ...
	    l_val = 1
	    sz_val = IM_MAXDIM
	    call amovkl (l_val, Meml[VPTR(vin,image)], sz_val)
	}

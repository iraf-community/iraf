...
define	H_RAWOUT	Memi[P2I($1+7)]	# if YES, do not process output
define	H_FILTER_INPUT	Memi[P2I($1+8)]	# if YES, filter out part of input
define	H_PAGINATE	Memi[P2I($1+9)]	# paginate output?
define	H_MANPAGE	Memi[P2I($1+10)]	# manpage style output?
define	H_NLPP		Memi[P2I($1+11)]	# number of lines per manual page
define	H_NLINES	Memi[P2I($1+12)]	# number of output lines on page
define	H_STATE		Memi[P2I($1+13)]	# input state, hinput()
define	H_EOF		Memi[P2I($1+14)]	# input should return EOF to Lroff
define	H_QUIT		Memi[P2I($1+15)]	# stop program
define	H_LENTL		Memi[P2I($1+16)]	# length of the TL template list
define	H_ALLMODULES	Memi[P2I($1+17)]	# process all modules matching template
define	H_FORMAT	Memi[P2I($1+18)]	# output format type
define	H_SOFLAG	Memi[P2I($1+19)]	# standout flags
			# (extra space)
...
define	HB_TYPE		Memi[P2I($1)]	# type of block (default TY_HLP)
define	HB_LINENO	Memi[P2I($1+1)]	# line number within file
define	HB_NKEYS	Memi[P2I($1+2)]	# number of keys

...
define	EX_FD		Memi[P2I($1)]	    # output binary file descriptor
define	EX_HEADER	Memi[P2I($1+1)]	    # write an output header?
define	EX_OUTTYPE	Memi[P2I($1+2)]	    # outtype parameter value
define	EX_INTERLEAVE	Memi[P2I($1+3)]	    # interleave parameter value
define	EX_BSWAP	Memi[P2I($1+4)]	    # bswap parameter value
define	EX_VERBOSE	Memi[P2I($1+5)]	    # verbose parameter value

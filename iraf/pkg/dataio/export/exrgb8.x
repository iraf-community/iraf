...
define	CBOX_GMAX	Memi[P2I($1+5)]
define	CBOX_BMIN	Memi[P2I($1+6)]
define	CBOX_BMAX	Memi[P2I($1+7)]
define	CBOX_TOTAL	Memi[P2I($1+8)]

# Color cell structure
define	CCELL_LEN	(A_LEN*2+1)
define	CCELL_NUM_ENTS	Memi[P2I($1)]
define	CCELL_ENTRIES	Memi[P2I($1+1)+2*($2)+$3]
...
begin
	...
	call smark (sp)
	sz_val = nc * 3
	call salloc (thisline, sz_val, TY_INT)
	call salloc (nextline, sz_val, TY_INT)

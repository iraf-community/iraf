...
define	X_HEADER_SIZE 	     Meml[P2L($1)]  		# Size of the header (bytes)
define	X_FILE_VERSION 	     Meml[P2L($1+1)]		# XWD_FILE_VERSION 
define	X_PIXMAP_FORMAT      Meml[P2L($1+2)]		# Pixmap format 
define	X_PIXMAP_DEPTH 	     Meml[P2L($1+3)]		# Pixmap depth 
define	X_PIXMAP_WIDTH 	     Meml[P2L($1+4)]		# Pixmap width 
define	X_PIXMAP_HEIGHT      Meml[P2L($1+5)]		# Pixmap height 
define	X_XOFFSET 	     Meml[P2L($1+6)]		# Bitmap x offset 
define	X_BYTE_ORDER 	     Meml[P2L($1+7)]		# MSBFirst, LSBFirst 
define	X_BITMAP_UNIT 	     Meml[P2L($1+8)]		# Bitmap unit 
define	X_BITMAP_BIT_ORDER   Meml[P2L($1+9)]		# MSBFirst, LSBFirst 
define	X_BITMAP_PAD 	     Meml[P2L($1+10)]	# Bitmap scanline pad 
define	X_BITS_PER_PIXEL     Meml[P2L($1+11)]	# Bits per pixel 
define	X_BYTES_PER_LINE     Meml[P2L($1+12)]	# Bytes per scanline 
define	X_VISUAL_CLASS 	     Meml[P2L($1+13)]	# Class of colormap 
define	X_RED_MASK 	     Meml[P2L($1+14)]	# Z red mask 
define	X_GREEN_MASK 	     Meml[P2L($1+15)]	# Z green mask 
define	X_BLUE_MASK 	     Meml[P2L($1+16)]	# Z blue mask 
define	X_BITS_PER_RGB 	     Meml[P2L($1+17)]	# Log2 of distinct color values 
define	X_COLORMAP_ENTRIES   Meml[P2L($1+18)]	# Number of entries in colormap 
define	X_NCOLORS 	     Meml[P2L($1+19)]	# Number of Color structures 
define	X_WINDOW_WIDTH 	     Meml[P2L($1+20)]	# Window width 
define	X_WINDOW_HEIGHT      Meml[P2L($1+21)]	# Window height 
define	X_WINDOW_X 	     Meml[P2L($1+22)]	# Window upper left X coordinate
define	X_WINDOW_Y 	     Meml[P2L($1+23)]	# Window upper left Y coordinate
define	X_WINDOW_BDRWIDTH    Meml[P2L($1+24)]	# Window border width 

...
define	GCOUNT		Memi[P2I($1+13)]	  # Number of groups
define	GLOBALHDR	Memi[P2I($1+14)]	  # Global header may be present
define	INHERIT		Memi[P2I($1+15)]	  # Inherit global header if present

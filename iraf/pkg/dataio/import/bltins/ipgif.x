...
define	GIF_LASTBYTE		Memi[P2I($1+17)]	# Decoder var
define	GIF_ZERO_DATABLOCK	Memi[P2I($1+18)]	# Decoder var
define	GIF_SP			Memi[P2I($1+19)]	# stack pointer

define	GIF_CLEAR_CODE		Memi[P2I($1+20)]	# LZW clear code
define	GIF_END_CODE		Memi[P2I($1+21)]	# LZW end code
define	GIF_FIRST_CODE		Memi[P2I($1+22)]	# LZW decoder var
define	GIF_OLD_CODE		Memi[P2I($1+23)]	# LZW decoder var
define	GIF_MAX_CODE		Memi[P2I($1+24)]	# LZW free code
define	GIF_MAX_CODE_SIZE	Memi[P2I($1+25)]	# LZW upper limit
define	GIF_CODE_SIZE		Memi[P2I($1+26)]	# LZW current code size
define	GIF_SET_CODE_SIZE	Memi[P2I($1+27)]	# LZW input code size
define	GIF_FRESH		Memi[P2I($1+28)]	# LZW init var

# The following are used for GIF89a only.
define	GIF_TRANSPARENT		Memi[P2I($1+30)]	# Transparent Color Index 
define	GIF_DELAYTIME		Memi[P2I($1+31)]	# Delay time
define	GIF_INPUTFLAG		Memi[P2I($1+32)]	# User input flag
define	GIF_DISPOSAL		Memi[P2I($1+33)]	# Disposal Method

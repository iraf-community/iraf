...
define	RG_PMIM		Memi[P2I($1)]		# the mask image
define	RG_PMIBUF	Memi[P2I($1+1)]		# the mask input data
...
begin
	...
	# etc. just return the scalar index value.
		...
		if (axis < 1 || axis > IM_MAXDIM) {
		    ...
		    sz_val = O_LEN(o)
		    call amovki (RG_OPMV(rg,axis), Memi[data], sz_val)
		}
		O_VALP(o) = data
		O_FLAGS(o) = O_FREEVAL
	    }
...
begin
	...
	case RG_CIRCLE:
	    ...
	    if (nargs == 5) {
		    ...
		    Memi[ix+i-1] = i
	        sz_val = O_LEN(o)
	        call amovki (RG_OPMV(rg,2), Memi[iy], sz_val)
	        sz_val = O_LEN(o)
	        call malloc (O_VALP(o), sz_val, TY_INT)
	...
	case RG_LINES:
	    ...
	    if (nargs == 2) {
        	...
        	call malloc (ix, sz_val, TY_INT)
	        sz_val = O_LEN(o)
	        call amovki (RG_OPMV(rg,2), Memi[ix], sz_val)
	        sz_val = O_LEN(o)
	        call malloc (O_VALP(o), sz_val, TY_INT)

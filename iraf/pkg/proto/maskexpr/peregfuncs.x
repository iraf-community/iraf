...
define	E_PL		Memi[P2I($1)]	# reference mask
...
define	E_PV		Memi[P2I($1+9)]	# pixel value
...
define	CA_PL		Memi[P2I($1)]	# reference mask
...
define	CA_PV		Memi[P2I($1+5)]	# pixel value
...
define	EA_PL		Memi[P2I($1)]	# reference mask
...
define	EA_PV		Memi[P2I($1+15)]	# pixel value
...
define	RA_PL		Memi[P2I($1)]	# the mask descriptor
define	RA_IXP		Memi[P2I($1+1)]	# pointer to inner polygon X vector
define	RA_IYP		Memi[P2I($1+2)]	# pointer to inner Y polygon vector
define	RA_OXP		Memi[P2I($1+3)]	# pointer to outer X polygon vector
define	RA_OYP		Memi[P2I($1+4)]	# pointer to outer Y polygon vector
define	RA_NVER		Memi[P2I($1+5)]	# number of vertices
define	RA_PV		Memi[P2I($1+6)]	# mask pixel value
...
define	PA_PL		Memi[P2I($1)]	# the mask descriptor
define	PA_IXP		Memi[P2I($1+1)]	# pointer to inner polygon X vector
define	PA_IYP		Memi[P2I($1+2)]	# pointer to inner Y polygon vector
define	PA_OXP		Memi[P2I($1+3)]	# pointer to outer X polygon vector
define	PA_OYP		Memi[P2I($1+4)]	# pointer to outer Y polygon vector
define	PA_NVER		Memi[P2I($1+5)]	# number of vertices
define	PA_PV		Memi[P2I($1+6)]	# mask pixel value
...
define	L_PL		Memi[P2I($1)]	# reference mask
define	L_RANGES	Memi[P2I($1+1)]	# pointer to the ranges	
define	L_NRANGES	Memi[P2I($1+2)]	# the number of ranges
define	L_XS		Memi[P2I($1+3)]	# the starting x coordinate value
define	L_NPIX		Memi[P2I($1+4)]	# the number of pixels value
define	L_PV		Memi[P2I($1+5)]	# pixel value
...
define	L_PL		Memi[P2I($1)]	# reference mask
define	L_RANGES	Memi[P2I($1+1)]	# pointer to the ranges	
define	L_PV		Memi[P2I($1+2)]	# pixel value

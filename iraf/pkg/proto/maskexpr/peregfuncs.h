...
define	C_PV		Meml[P2L($1+4)]	# pixel value


# Ellipse definitions.

define	LEN_ELLDES	10
define	E_PL		Memp[$1]	# reference mask
...
define	E_PV		Meml[P2L($1+9)]	# pixel value
...
define	P_PV		Meml[P2L($1+6)]	# pixel value


# Circular annulus definitions.

define	LEN_CANNDES	6
define	CA_PL		Memp[$1]	# reference mask
...
define	CA_PV		Meml[P2L($1+5)]	# pixel value


# Elliptical annulus defintiions.

define	LEN_EANNDES	16
define	EA_PL		Memp[$1]	# reference mask
...
define	EA_PV		Meml[P2L($1+15)] # pixel value


# Rasterop annulus definitions.

define	LEN_RANNDES	7
define	RA_PL		Memp[$1]	# the mask descriptor
define	RA_IXP		Memp[$1+1]	# pointer to inner polygon X vector
define	RA_IYP		Memp[$1+2]	# pointer to inner Y polygon vector
define	RA_OXP		Memp[$1+3]	# pointer to outer X polygon vector
define	RA_OYP		Memp[$1+4]	# pointer to outer Y polygon vector
define	RA_NVER		Memi[P2I($1+5)]	# number of vertices
define	RA_PV		Meml[P2L($1+6)]	# mask pixel value


# Polygon annulus definitions.

define	LEN_PAGONDES	7
define	PA_PL		Memp[$1]	# the mask descriptor
define	PA_IXP		Memp[$1+1]	# pointer to inner polygon X vector
define	PA_IYP		Memp[$1+2]	# pointer to inner Y polygon vector
define	PA_OXP		Memp[$1+3]	# pointer to outer X polygon vector
define	PA_OYP		Memp[$1+4]	# pointer to outer Y polygon vector
define	PA_NVER		Memi[P2I($1+5)]	# number of vertices
define	PA_PV		Meml[P2L($1+6)]	# mask pixel value


# Column definitions.

define	LEN_COLSDES	4
define	L_PL		Memp[$1]	# reference mask
define	L_RANGES	Memp[$1+1]	# pointer to the ranges	
define	L_NRANGES	Memi[P2I($1+2)]	# the number of ranges
define	L_XS		Meml[P2L($1+3)]	# the starting x coordinate value
define	L_NPIX		Memz[P2Z($1+4)]	# the number of pixels value
define	L_PV		Meml[P2L($1+5)]	# pixel value
...
define	L_PL		Memp[$1]	# reference mask
define	L_RANGES	Memp[$1+1]	# pointer to the ranges	
define	L_PV		Meml[P2L($1+2)]	# pixel value

...
define	ME_PMIM		Memi[P2I($1)]		# the output mask image
define	ME_REFIM	Memi[P2I($1+1)]		# the reference image
define	ME_REFMSK	Memi[P2I($1+2)]		# the reference mask image
define	ME_REFDAT	Memi[P2I($1+3)]		# current reference image line
define	ME_REFTYPE	Memi[P2I($1+4)]		# the input pixel type
define	ME_REFPMDAT	Memi[P2I($1+5)]		# current mask image line
...
begin
	...
	# etc. just return the scalar index value.
		...
		if (axis < 1 || axis > IM_MAXDIM) {
		    sz_val = O_LEN(o)
		    call amovki (1, Memi[data], sz_val)
		} else {
		    sz_val = O_LEN(o)
		    call amovki (ME_PMV(me,axis), Memi[data], sz_val)
		}
		O_VALP(o) = data
		O_FLAGS(o) = O_FREEVAL
	    }
...
begin
	...
	case ME_CIRCLE:
	    ...
	    if (nargs == 5) {
		    ...
		    Memi[ix+i-1] = i
	        sz_val = O_LEN(o)
	        call amovki (ME_PMV(me,2), Memi[iy], sz_val)
	        sz_val = O_LEN(o)
	        call malloc (O_VALP(o), sz_val, TY_INT)
	...
	case ME_LINES:
	    ...
	    if (nargs == 2) {
	        ...
	        call malloc (ix, sz_val, TY_INT)
	        sz_val = O_LEN(o)
	        call amovki (ME_PMV(me,2), Memi[ix], sz_val)
	        sz_val = O_LEN(o)
	        call malloc (O_VALP(o), sz_val, TY_INT)

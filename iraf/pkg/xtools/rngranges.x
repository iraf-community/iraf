...
define	RNG_NPTS	Memi[P2I($1)]		# Number of points in ranges
define	RNG_NRNGS	Memi[P2I($1+1)]		# Number of range intervals
define	RNG_X1		Memr[P2R($1+2+4*($2)-4)]	# Start of range
define	RNG_X2		Memr[P2R($1+3+4*($2)-4)]	# End of range
define	RNG_DX		Memr[P2R($1+4+4*($2)-4)]	# Interval step
define	RNG_NX		Memi[P2I($1+5+4*($2)-4)]	# Number of intervals step

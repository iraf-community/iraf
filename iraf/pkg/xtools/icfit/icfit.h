...
define	IC_SAMPLE	Memp[$1+2]	# Pointer to sample string
define	IC_NAVERAGE	Meml[P2L($1+3)]	# Sampling averaging bin
...
define	IC_NFIT		Memz[P2Z($1+10)]	# Number of fit points
define	IC_NREJECT	Memz[P2Z($1+11)]	# Number of rejected points
define	IC_RG		Memp[$1+12]	# Pointer for ranges
define	IC_XFIT		Memp[$1+13]	# Pointer to ordinates of fit points
define	IC_YFIT		Memp[$1+14]	# Pointer to abscissas of fit points
define	IC_WTSFIT	Memp[$1+15]	# Pointer to weights of fit points
define	IC_REJPTS	Memp[$1+16]	# Pointer to rejected points
...
define	IC_LABELS	Memp[$1+25+$2-1]	# Graph axis labels
define	IC_UNITS	Memp[$1+27+$2-1]	# Graph axis units
define	IC_HELP		Memp[$1+29]	# Pointer to help file name
define	IC_GP		Memp[$1+30]	# GIO pointer
define	IC_GT		Memp[$1+31]	# GTOOLS pointer

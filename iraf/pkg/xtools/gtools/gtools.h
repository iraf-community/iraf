...
define	GT_SYSID	Memi[P2I($1+GTSYSID)]
define	GT_PARAMS	Memi[P2I($1+GTPARAMS)]
define	GT_TITLE	Memi[P2I($1+GTTITLE)]
define	GT_SUBTITLE	Memi[P2I($1+GTSUBTITLE)]
define	GT_COMMENTS	Memi[P2I($1+GTCOMMENTS)]
define	GT_XLABEL	Memi[P2I($1+GTXLABEL)]
define	GT_YLABEL	Memi[P2I($1+GTYLABEL)]
define	GT_XUNITS	Memi[P2I($1+GTXUNITS)]
define	GT_YUNITS	Memi[P2I($1+GTYUNITS)]
define	GT_DRWTITLE	Memi[P2I($1+GTDRAWTITLE)]
define	GT_DRWXLABELS	Memi[P2I($1+GTDRAWXLABELS)]
define	GT_DRWYLABELS	Memi[P2I($1+GTDRAWYLABELS)]
define	GT_TYPE		Memi[P2I($1+GTTYPE)]
define	GT_MARK		Memi[P2I($1+GTMARK)]
define	GT_LINE		Memi[P2I($1+GTLINE)]
define	GT_XSIZE	Memr[P2R($1+GTXSIZE)]
define	GT_YSIZE	Memr[P2R($1+GTYSIZE)]
define	GT_COLOR	Memi[P2I($1+GTCOLOR)]
define	GT_XTRAN	Memi[P2I($1+GTXTRAN)]
define	GT_YTRAN	Memi[P2I($1+GTYTRAN)]
define	GT_XFLIP	Memi[P2I($1+GTXFLIP)]
define	GT_YFLIP	Memi[P2I($1+GTYFLIP)]
define	GT_TRANSPOSE	Memi[P2I($1+GTTRANSPOSE)]
define	GT_XFORMAT	Memi[P2I($1+GTXFORMAT)]
define	GT_YFORMAT	Memi[P2I($1+GTYFORMAT)]
...
define	GT_RESET	Memi[P2I($1+GTRESET)]

...
define	GT_PARAMS	Memp[$1+GTPARAMS]
define	GT_TITLE	Memp[$1+GTTITLE]
define	GT_SUBTITLE	Memp[$1+GTSUBTITLE]
define	GT_COMMENTS	Memp[$1+GTCOMMENTS]
define	GT_XLABEL	Memp[$1+GTXLABEL]
define	GT_YLABEL	Memp[$1+GTYLABEL]
define	GT_XUNITS	Memp[$1+GTXUNITS]
define	GT_YUNITS	Memp[$1+GTYUNITS]
...
define	GT_XFORMAT	Memp[$1+GTXFORMAT]
define	GT_YFORMAT	Memp[$1+GTYFORMAT]

...
begin
	...
	call gsetr (gp, G_TXSIZE, Memr[gt+GT_TXSIZE])
	call gseti (gp, G_TXPATH, Memi[gt+GT_TXPATH])
	call gsetr (gp, G_TXSPACING, Memr[gt+GT_TXSPACING])
	...
	call gsetr (gp, G_TITLESIZE, Memr[gt+GT_TITLESIZE])
	#call gseti (gp, G_TITLEJUST, Memi[gt+GT_TITLEJUST])
	call gseti (gp, G_NTITLELINES, Memi[gt+GT_NTITLELINES])
	call gsetr (gp, G_ASPECT, Memr[gt+GT_ASPECT])
	#call gsetr (gp, G_CHARSIZE, Memr[gt+GT_CHARSIZE])
	...
	call gsetr (gp, G_XAXISPOS1, Memr[gt+GT_XAXISPOS1])
	call gsetr (gp, G_XAXISPOS2, Memr[gt+GT_XAXISPOS2])
	...
	call gsetr (gp, G_XAXISLABELSIZE, Memr[gt+GT_XAXISLABELSIZE])
	...
	call gsetr (gp, G_XMAJORLENGTH, Memr[gt+GT_XMAJORLENGTH])
	call gsetr (gp, G_XMINORLENGTH, Memr[gt+GT_XMINORLENGTH])
	call gsetr (gp, G_XMAJORWIDTH, Memr[gt+GT_XMAJORWIDTH])
	call gsetr (gp, G_XMINORWIDTH, Memr[gt+GT_XMINORWIDTH])
	call gsetr (gp, G_XAXISWIDTH, Memr[gt+GT_XAXISWIDTH])
	call gsetr (gp, G_XTICKLABELSIZE, Memr[gt+GT_XTICKLABELSIZE])
	...
	call gsetr (gp, G_YAXISPOS1, Memr[gt+GT_YAXISPOS1])
	call gsetr (gp, G_YAXISPOS2, Memr[gt+GT_YAXISPOS2])
	...
	call gsetr (gp, G_YAXISLABELSIZE, Memr[gt+GT_YAXISLABELSIZE])
	...
	call gsetr (gp, G_YMAJORLENGTH, Memr[gt+GT_YMAJORLENGTH])
	call gsetr (gp, G_YMINORLENGTH, Memr[gt+GT_YMINORLENGTH])
	call gsetr (gp, G_YMAJORWIDTH, Memr[gt+GT_YMAJORWIDTH])
	call gsetr (gp, G_YMINORWIDTH, Memr[gt+GT_YMINORWIDTH])
	call gsetr (gp, G_YAXISWIDTH, Memr[gt+GT_YAXISWIDTH])
	call gsetr (gp, G_YTICKLABELSIZE, Memr[gt+GT_YTICKLABELSIZE])

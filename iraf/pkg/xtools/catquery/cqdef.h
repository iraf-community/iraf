...
define	CQ_NRECS      Memi[P2I($1+2)]		# The number of records
define	CQ_MAP	      Memi[P2I($1+3)]		# The pointer to record names
define	CQ_NAMES      Memi[P2I($1+4)]		# The pointer to name indices
define	CQ_OFFSETS    Memi[P2I($1+5)]		# The pointer to record offsets
define	CQ_CATNO      Memi[P2I($1+6)]		# The current catalog number
define	CQ_CAT	      Memi[P2I($1+7)]  		# The current catalog descriptor
...
define	CQ_PQPNAMES   Memi[P2I($1+1)]	        # The query param names ptr
define	CQ_PQPDVALUES Memi[P2I($1+2)]	        # The query param defaults ptr
define	CQ_PQPVALUES  Memi[P2I($1+3)]	        # The query param values ptr
define	CQ_PQPUNITS   Memi[P2I($1+4)]	        # The query param units ptr
define	CQ_PQPFMTS    Memi[P2I($1+5)]                # The query param format ptr
...
define	CQ_RQPNAMES     Memi[P2I($1+1)]      # The query param names ptr
define	CQ_RQPVALUES    Memi[P2I($1+2)]      # The query param values ptr
define	CQ_RQPUNITS     Memi[P2I($1+3)]      # The query param units ptr

define	CQ_RTYPE	Memi[P2I($1+4)]	# The results data format
define	CQ_RECSIZE	Memi[P2I($1+5)]      # The results record size 
...
define	CQ_RTSKIP	Memi[P2I($1+9)]      # The number of trailer records to skip

define	CQ_NHEADER	Memi[P2I($1+10)]	# The number of header keywords
define	CQ_HKNAMES	Memi[P2I($1+11)]     # The results keyword names
define	CQ_HKVALUES	Memi[P2I($1+12)]     # The result keyword values

define	CQ_NFIELDS	Memi[P2I($1+13)]	# The number of record fields
define	CQ_FNAMES	Memi[P2I($1+14)]     # The record field names
define	CQ_FTYPES	Memi[P2I($1+15)]     # The record field data types ptr
define	CQ_FOFFSETS	Memi[P2I($1+16)]     # The record field offsets ptr
define	CQ_FSIZES	Memi[P2I($1+17)]     # The record field sizes ptr
define	CQ_FUNITS	Memi[P2I($1+18)]     # The record field units
...
define	CQ_RECPTR	Memi[P2I($1+24)] 	# The current record
define	CQ_FNFIELDS	Memi[P2I($1+25)]     # The number of fields in current record
define	CQ_FINDICES	Memi[P2I($1+26)]     # The current record indices pointer
...
define	CQ_IQPNAMES     Memi[P2I($1+1)]      # The query param names ptr
define	CQ_IQPVALUES    Memi[P2I($1+2)]      # The query param values ptr
define	CQ_IQPUNITS     Memi[P2I($1+3)]      # The query param units ptr
...
define	CQ_WPNAMES	Memi[P2I($1+12)]     # The wcs parameter names
define	CQ_WKNAMES	Memi[P2I($1+13)]	# The wcs keyword names	
define	CQ_WKDVALUES	Memi[P2I($1+14)]	# The wcs keyword default values
define	CQ_WKVALUES	Memi[P2I($1+15)]	# The wcs keyword values
define	CQ_WKTYPES	Memi[P2I($1+16)]	# The wcs keyword data types
define	CQ_WKUNITS	Memi[P2I($1+17)]	# The wcs keyword value units

define	CQ_NIMPARS	Memi[P2I($1+19)]	# The number of header keywords
define	CQ_IPNAMES	Memi[P2I($1+20)]     # The results keyword names
define	CQ_IKNAMES	Memi[P2I($1+21)]     # The result keyword values
define	CQ_IKDVALUES	Memi[P2I($1+22)]     # The result keyword values
define	CQ_IKVALUES	Memi[P2I($1+23)]     # The result keyword values
define	CQ_IKTYPES	Memi[P2I($1+24)]     # The result keyword values
define	CQ_IKUNITS	Memi[P2I($1+25)]     # The result keyword values

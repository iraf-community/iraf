...
define	IN_DEFHELP	"base$scr/inlgfit.key"
...
define	IN_NREJECT	Memi[P2I($1+12)]	# number of rejection iteration
...
define	IN_OVERPLOT	Memi[P2I($1+20)]	# overplot next plot ?
define	IN_PLOTFIT	Memi[P2I($1+21)]	# overplot fit ?
define	IN_FITERROR	Memi[P2I($1+22)]	# error fit code

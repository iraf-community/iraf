...
define	W_DEVICE	Memi[P2I($1)]
define	W_FRAME		Memi[P2I($1+1)]		# device frame number
...
define	W_XT		Memi[P2I($1+2)]		# X transformation type
define	W_YS		Memr[P2R($1+3)]		# starting Y value
define	W_YE		Memr[P2R($1+4)]		# ending Y value
define	W_YT		Memi[P2I($1+5)]		# Y transformation type

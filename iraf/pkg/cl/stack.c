 ...
 *			...
 */
struct operand pushop ( struct operand *op )
{
 ...
 */
static int last_task_frame;				/* for error recovery */

struct task *pushtask ( void )
{

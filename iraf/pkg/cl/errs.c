...
const char	*e_appopen =	"can not open `%s' for appending";
const char	*e_badstrop =	"illegal operation on string '%0.20s'";
const char	*e_badsw =	"bad switch case, %d, in `%s'";
/* const char	*e_edom =	"function argument outside valid range: %g"; */
/* const char	*e_erange =	"%g caused arithmetic overflow"; */
/* const char	*e_fpe =	"floating point exception"; */
const char	*e_geonearg =	"`%s' requires at least one argument";
const char	*e_indexunf=	"no indices on stack for array reference";
const char *e_nominmax = "structs, strings, cursors and booleans do not have ranges";
const char	*e_nopfile =	"task `%s' has no param file";
const char	*e_badpfile =	"cannot read parameter file `%s'";
const char	*e_nostrcnv =	"may not convert string to other types";
/* const char	*e_notbool =	"parameter `%s' is not boolean"; */
const char	*e_onearg =	"`%s' expects one argument";
const char	*e_pambig =	"ambiguous parameter `%s' within `%s'";
const char	*e_pckambig =	"ambiguous package `%s'";
const char	*e_pcknonexist=	"package `%s' not found";
const char	*e_posargs =	"too many positional arguments for `%s'";
const char	*e_pnonexist =	"parameter `%s' not found";
const char	*e_ropen =	"cannot open `%s' for reading";
const char	*e_simplep =	"use simple parameter name only for `%s'";
const char	*e_strplusreal= "attempt to add operand of type real to string `%s'";
const char	*e_soverflow =	"stack overflow (cs:%d,os:%d)";
const char	*e_sunderflow =	"stack underflow";
const char	*e_tambig =	"ambiguous task `%s'";
const char	*e_twoargs =	"`%s' expects two arguments";
const char	*e_tnonexist =	"task `%s' not found";
/* const char	*e_unlink =	"cannot remove file `%s'"; */
const char	*e_uopcode =	"undefined opcode %d";
const char	*e_wopen =	"cannot open `%s' for writing";
const char	*e_lookparm =	"error searching for parameter `%s'.";
const char	*e_invaldef=	"conflicting attributes in definition of `%s'.";
const char	*e_fdivzero =	"floating divide by zero";
const char	*e_idivzero =	"integer divide by zero";

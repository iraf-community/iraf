...
extern int	nextdest[];		/* Destinations for NEXT's 	*/
extern int	brkdest[];		/* Destinations for BREAK's 	*/
...
extern int	oarr_beg[];		/* Open index limits.		*/
extern int	oarr_end[];
extern int	oarr_curr[];		/* Current value for index.	*/

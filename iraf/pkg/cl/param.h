...
/* param.c */
/* searches for a param on a given pfile */
extern struct param *paramfind( struct pfile *, const char *, int, int );
/* search, make sure param is there */
extern struct param *paramsrch( const char *, const char *, const char * );
/* search standard path for a param */
extern struct param *lookup_param( const char *, const char *, const char * );
/* allocate and link a new param */
extern struct param *newparam( struct pfile * );
/* add a fake param to pfile */
extern struct param *newfakeparam( struct pfile *, const char *, int, int, int );
/* determine whether param exists */
extern int defpar( const char * );
/* determine whether envvar exists */
extern int defvar( const char * );

extern void paramset ( struct param *, char );
extern void paramget ( struct param *, char );
extern int printparam ( struct param *, FILE * );
extern int pvaldefined ( struct param *, const char * );
extern void offsetmode ( int );
extern int getoffset( struct param * );
extern int size_array ( struct param * );
extern void validparamget ( struct param *, char );
extern void makemode ( struct param *, char *, int );


/* gram.c */
extern void listparams ( struct pfile * );
extern void dumpparams ( struct pfile * );
/* convert n:n:n string to sexagesimal	*/
extern struct operand sexa ( const char * );

/* operand.c */
extern void opcast ( int );
extern void sprop ( char *, int, struct operand * );
extern void spparval ( char *, int, struct param * );
extern struct operand makeop( const char *, int );
extern void fprop ( FILE *, struct operand * );
extern void oprop ( struct operand * );
extern void opindir( void );
extern void prop ( struct operand * );

/* unop.c */
extern void unop ( int );
extern void unexp ( int );

/* binop.c */
extern void binop ( int );
extern void binexp ( int );


/* lists.c */
/* read and return operand from list	*/
extern struct operand readlist( struct param * );
extern void closelist ( struct param * );

/* stack.c */
extern struct operand popop( void );
extern struct operand pushop( struct operand * );

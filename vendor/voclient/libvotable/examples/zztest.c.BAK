...
int pseudocode1(char *fname)
{
    handle_t vot, res, data, tab, field, tr, td, fits, stream, tdata, bin;
    ...
    while(res)
    {
        ...
        case TY_BINARY:
            /* Get data stored as inline binary. If the encoding of
               the stream is based64 read the sequence of bytes and decode. */
        ...
        case TY_FITS:
            /* Read FITS data. Assumes a particular extension of an
               MEF is avaliable for download at the given href. */
...
int pseudocode5_copy(char *fname1, char *fname2)
{
...
int pseudocode5(char *fname1, char *fname2)
{
    handle_t vot2, res2;
    handle_t vot1, res1;
    handle_t vot3;

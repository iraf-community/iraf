...
#define TY_COOSYS     	020000000	/* deprecated elements		*/
#define TY_DEFINITIONS  040000000
...
void 	 vot_writeASV (handle_t node, char *fname);
void 	 vot_writeBSV (handle_t node, char *fname);
void 	 vot_writeCSV (handle_t node, char *fname);
void 	 vot_writeTSV (handle_t node, char *fname);

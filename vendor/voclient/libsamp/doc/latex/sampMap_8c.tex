...
void \hyperlink{sampMap_8c_fe80438de542c6657d623993360b37d1}{samp\_\-freeMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map)
\begin{CompactList}\small\item\em Free the given Map object. \item\end{CompactList}\item 
void \hyperlink{sampMap_8c_b9b2157de89369eb5cd95bfe804eb89a}{samp\_\-setStringInMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map, char $\ast$key, char $\ast$value)
\begin{CompactList}\small\item\em Set a string in a Map (append). \item\end{CompactList}\item 
void \hyperlink{sampMap_8c_f102490efe1b92d99b67f244dc498c7b}{samp\_\-setMapInMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map1, char $\ast$key, \hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map2)
\begin{CompactList}\small\item\em Set a Map in a Map (append). \item\end{CompactList}\item 
void \hyperlink{sampMap_8c_362c2f670c98dd6a3ef69debd1871604}{samp\_\-setListInMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map, char $\ast$key, \hyperlink{samp_8h_39f9d235896a8fd920f319105eb82791}{List} list)
\begin{CompactList}\small\item\em Set a List in a Map (append). \item\end{CompactList}\item 
void \hyperlink{sampMap_8c_c22ec42dbf9a01c9b4e00cf011e7eb9d}{samp\_\-setIntInMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map, char $\ast$key, int value)
\begin{CompactList}\small\item\em Set a Int in a Map (append). \item\end{CompactList}\item 
void \hyperlink{sampMap_8c_0f07ae542f5b317311b3799bd96a88fd}{samp\_\-setFloatInMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map, char $\ast$key, float value)
\begin{CompactList}\small\item\em Set a string in a Map (append). \item\end{CompactList}\item 
char $\ast$ \hyperlink{sampMap_8c_96ca606e0e7da659c3dc0a30846bcd66}{samp\_\-getStringFromMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map, char $\ast$key)
\begin{CompactList}\small\item\em Get a string from the Map. \item\end{CompactList}\item 
\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} \hyperlink{sampMap_8c_525e8ffdfa32867f392f2c1340215453}{samp\_\-getMapFromMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map, char $\ast$key)
\begin{CompactList}\small\item\em Get a Map from the Map. \item\end{CompactList}\item 
\hyperlink{samp_8h_39f9d235896a8fd920f319105eb82791}{List} \hyperlink{sampMap_8c_31ddb90cf2184ae0151b9e7ec8c1a51f}{samp\_\-getListFromMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map, char $\ast$key)
\begin{CompactList}\small\item\em Get a LIST from the Map. \item\end{CompactList}\item 
int \hyperlink{sampMap_8c_210fc0eba30abddf1bdc2e780d58072c}{samp\_\-getIntFromMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map, char $\ast$key)
\begin{CompactList}\small\item\em Get a integer from the Map. \item\end{CompactList}\item 
float \hyperlink{sampMap_8c_b0d3768990294554a298c4057b3b315d}{samp\_\-getFloatFromMap} (\hyperlink{samp_8h_39a90bc041db57e1a6ba736ba91eee30}{Map} map, char $\ast$key)
...
str = samp\_\-getStringFromMap (Map map, char $\ast$key) map = samp\_\-getMapFromMap (Map map, char $\ast$key) list = samp\_\-getListFromMap (Map map, char $\ast$key) ival = samp\_\-getIntInMap (Map map, char $\ast$key) rval = samp\_\-getFloatInMap (Map map, char $\ast$key)
...
Referenced by samp\_\-execUserHandler(), samp\_\-pointAtHandler(), and samp\_\-printMessage().\hypertarget{sampMap_8c_210fc0eba30abddf1bdc2e780d58072c}{
...
Referenced by samp\_\-execUserHandler(), samp\_\-printMessage(), and samp\_\-tbHighlightHandler().\hypertarget{sampMap_8c_31ddb90cf2184ae0151b9e7ec8c1a51f}{
...
Referenced by samp\_\-tbSelectHandler().\hypertarget{sampMap_8c_525e8ffdfa32867f392f2c1340215453}{
...
Referenced by samp\_\-printMessage(), and samp\_\-specLoadHandler().\hypertarget{sampMap_8c_96ca606e0e7da659c3dc0a30846bcd66}{

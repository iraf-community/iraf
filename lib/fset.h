...
define	F_DEVCODE	11	#* device driver code (index in device table)
define	F_DEVICE	12	#* entry point address device read/get routine
...
define	F_FIODES	17	#* struct pointer to file descriptor structure
...
define	F_SZBBLK	32	#r size in bytes of last dev block read|written
...
define	F_FIRSTBUFOFF	39	#  file offset of first FIO buffer (default=1)
define	F_SETREDRAW	40	#w set/enable screen redraw code (suspend proc)
...
define	F_NDELAY	100B	# nonblocking i/o

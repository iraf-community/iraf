...
procedure qpio_loadmask (io, mask)

pointer	io			#I QPIO descriptor
char	mask[ARB]		#I mask to be loaded

int	niter
int	naxes, axlen[NDIM]
pointer	sp, title, mp, sym, plbuf, qp
...
tryfile_
		IO_PL(io) = pl_open (NULL)
		call pl_loadf (IO_PL(io), Memc[mp], Memc[title], SZ_FNAME)
		IO_PLCLOSE(io) = YES

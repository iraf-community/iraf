...
pointer	pp				# pointer to param descriptor
char	outstr[maxch]			# receives token
int	maxch, token
pointer	ip, ip_start, op
int	stridx()
...
int	fd, ip, op, fnt_delim, pat_start
int	open(), diropen()
...
begin
	...
	if (ftype == LIST_FILE) {
	    ...
	    fd = diropen (ldir, SKIP_HIDDEN_FILES)

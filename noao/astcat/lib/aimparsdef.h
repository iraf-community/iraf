...
define	AT_ESITEALT	Memr[$1+6]
define	AT_ESITETZ	Memr[$1+7]
#define	AT_EXPOSURE	Memr[$1+8]
define	AT_EDATAMIN	Memr[$1+9]
define	AT_EDATAMAX	Memr[$1+10]
define	AT_EGAIN	Memr[$1+11]
define	AT_ERDNOISE	Memr[$1+12]
define	AT_EWAVLEN	Memr[$1+13]
define	AT_ETEMP	Memr[$1+14]
define	AT_EPRESS	Memr[$1+15]

...
define	SKB_SIGBIN	Memr[$1+5]	# Histogram sigma limit
define	SKB_A		Memr[$1+6]	# Histogram resolution
define	SKB_B		Memr[$1+7]	# Bin start
...
define	SKB_SIGFAC	Memr[$1+11]	# Sigma correction factor
define	SKB_FRAC	Memr[$1+12]	# Frac of sky pix in subblock
define	SKB_GROW	Memr[$1+13]	# Grow for rejected subblocks

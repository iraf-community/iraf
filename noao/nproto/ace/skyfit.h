...
define	SKF_STEP	Memr[$1]	# Number of sky lines to sample
define	SKF_LMIN	Memr[$1+1]	# Minimum number of lines to fit
...
define	SKF_HCLIP	Memr[$1+8]	# Sky fitting high sigma clip
define	SKF_LCLIP	Memr[$1+9]	# Sky fitting low sigma clip

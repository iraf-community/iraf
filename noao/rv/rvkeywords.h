...
define	KW_W0		Memc[RV_KEYW($1)+ 7*LEN_KEYWEL+1]
define	KW_WPC		Memc[RV_KEYW($1)+ 8*LEN_KEYWEL+1]
define	KW_HJD		Memc[RV_KEYW($1)+ 9*LEN_KEYWEL+1]
define	KW_MJD_OBS	Memc[RV_KEYW($1)+10*LEN_KEYWEL+1]
define	KW_VOBS		Memc[RV_KEYW($1)+11*LEN_KEYWEL+1]
define	KW_VREL		Memc[RV_KEYW($1)+12*LEN_KEYWEL+1]
define	KW_VHELIO	Memc[RV_KEYW($1)+13*LEN_KEYWEL+1]
define	KW_VLSR		Memc[RV_KEYW($1)+14*LEN_KEYWEL+1]
define	KW_VSUN		Memc[RV_KEYW($1)+15*LEN_KEYWEL+1]

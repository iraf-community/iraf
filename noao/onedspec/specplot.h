...
define	SP_W0		Memr[$1+3]		# Starting wavelength
define	SP_WPC		Memr[$1+4]		# Wavelength per pix
...
define	SP_XSCALE	Memr[$1+8]		# Wavelength scale
define	SP_XOFFSET	Memr[$1+9]		# Wavelength offset
define	SP_SCALE	Memr[$1+10]		# Intensity scale
define	SP_OFFSET	Memr[$1+11]		# Intensity offset
define	SP_MEAN		Memr[$1+12]		# Mean intensity
define	SP_MIN		Memr[$1+13]		# Minimum intensity
define	SP_MAX		Memr[$1+14]		# Maximum intensity

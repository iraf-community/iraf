...
define	SF_FOCUS	Memr[$1+40]	# Focus
define	SF_WIDTH	Memr[$1+41]	# Width
define	SF_LEVEL	Memr[$1+42]	# Level of width
...
define	SF_X		Memr[$1]	# Dispersion axis coordinate
define	SF_Y		Memr[$1+1]	# Spatial axis coordinate
define	SF_SPEC		Memi[$1+2]	# Pointer to spectrum
define	SF_ASI		Memi[$1+3]	# Pointer to correlation profile
define	SF_FOC		Memr[$1+4]	# Focus
define	SF_WID		Memr[$1+5]	# Width
define	SF_POS		Memr[$1+6]	# Position

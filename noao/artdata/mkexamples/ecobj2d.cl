...
mkechelle (out, yes, ncols=512, nlines=512, norders=21,
    ...
    lines="", nrandom=500, peak=-0.5, sigma=0.5, seed=1, >& "dev$null")

mkechelle (out, yes, ncols=512, nlines=512, norders=21,
    title="Artificial Echelle Spectrum", header="artdata$stdheader.dat",
    list=no, make=yes, xc=235.5, yc=INDEF, pixsize=0.027,
    profile="slit", width=20., scattered=10., f=590., gmm=31.6, blaze=63.,
    theta=69., order=112, wavelength=5007.49, dispersion=2.61, cf=590.,
    cgmm=226., cblaze=4.53, ctheta=-11.97, corder=1, cwavelength=6700.,
    cdispersion=70., rv=0., z=no, continuum=200., temperature=5700.,
    lines="", nrandom=20, peak=5.0, sigma=0.1, seed=2, >& "dev$null")

...
int procedure apsfelgauss (ctrpix, nx, ny, fwhmpsf, noise, sigma, maxiter, k2,
	nreject, par, perr, npar)
...
begin
	...
	# Setup x, y, weight and list arrays.
	do i = 1, nx
	    Memr[x+i-1] = i
	do i = 1, ny
	    Memr[y+i-1] = i
	...
	call alimr (ctrpix, nx * ny, par[7], par[1])
	par[1] = par[1] - par[7]
	par[2] = (1. + nx) / 2.
	par[3] = (1. + ny) / 2.
	par[4] = (fwhmpsf ** 2 / 4.0)

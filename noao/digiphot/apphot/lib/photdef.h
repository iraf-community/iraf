...
define	AP_XAPIX		Memi[$1+7]	# Pointer to x coords array
define	AP_YAPIX		Memi[$1+8]	# Pointer to y coords array
define	AP_NAPIX		Memi[$1+9]	# Number of pixels
define	AP_LENABUF		Memi[$1+10]	# Size of pixels buffer

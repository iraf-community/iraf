...
define  AP_ORPXCUR	Memr[$1+7]	# output system X image center in pixels
define	AP_ORPYCUR	Memr[$1+8]	# output system Y image center in pixels

# Radprof fit parameters

define	AP_RPRADIUS	Memr[$1+9]	# Radprof radius in scale
define	AP_RPSTEP	Memr[$1+10]	# Radprof step size in scale
define	AP_RPORDER	Memi[$1+11]	# Order of the spline3 fit
define	AP_RPKSIGMA	Memr[$1+12]	# Radprof K-rejection criterion in sigma
...
define	AP_INORM	Memr[$1+19]	# Normalization for intensity profile
define	AP_TINORM	Memr[$1+20]	# Normalization for total intensity
define	AP_DNORM	Memr[$1+21]	# Normalization for incremental inten
define	AP_RPFWHM	Memr[$1+22]	# Fitted profile FWHM

...
begin
	...
	call ap_rparam (out, KY_ITIME, apstatr (ap, ITIME), UN_ITIME,
	    "exposure time")
	call fprintf (out, "#\n")
...
# AP_WPHOT -- Procedure to write out the photometry parameters.

procedure ap_wphot (ap, out)

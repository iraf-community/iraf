...
define	CAT_MAG		7		# magnitude
define	CAT_MERR	8		# magnitude error

define	OBS_NFIELDS	4
...
define	LEN_IMT_STRUCT	(9 + 3 * SZ_FNAME + 3)	
...
define	IMT_IFILTER	Memc[P2C($1+9)]		     # the filter ids
define	IMT_LABEL	Memc[P2C($1+9+SZ_FNAME+1)]   # image set labels
define	IMT_IMNAME	Memc[P2C($1+9+2*SZ_FNAME+2)] # image names

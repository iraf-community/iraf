# The Aperture Photometry Structure Definition
...
# Define parameters for reading APPHOT PHOT results
...
define	DP_PAPGROUP	7	# Star GROUP number
...
# define the column names for reading and writing APPHOT PHOT and
# DAOPHOT results

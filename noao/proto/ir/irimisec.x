...
int procedure ir_decode_section (section, c1ref, c2ref, l1ref, l2ref)
...
begin
	...
	if (index == 0)
	    return (ERR)
	ip = index + 1
        if (ir_decode_subscript (section, ip, c1ref, c2ref, step) == ERR)
	    return (ERR)
        if (ir_decode_subscript (section, ip, l1ref, l2ref, step) == ERR)
	    return (ERR)
	return (OK)
end
...
int procedure ir_decode_subscript (section, ip, x1, x2, step)
